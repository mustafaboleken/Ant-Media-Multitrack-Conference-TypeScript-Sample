...
// @ts-ignore
const utils_js_1 = require("./js/utils.js");
/**
 ...
 */
var token = typeof (0, js_2.getUrlParameter)("token") == "string" ? (0, js_2.getUrlParameter)("token") : "";
var publishStreamId = typeof (0, js_2.getUrlParameter)("streamId") == "string" ? (0, js_2.getUrlParameter)("streamId") : (0, utils_js_1.generateRandomString)();
var playOnly = (0, js_2.getUrlParameter)("playOnly") == "boolean" ? (0, js_2.getUrlParameter)("playOnly") : false;
var dcOnly = typeof (0, js_2.getUrlParameter)("dcOnly") == "boolean" ? (0, js_2.getUrlParameter)("dcOnly") : false;
var roomId = typeof (0, js_2.getUrlParameter)("roomId") == "string" ? (0, js_2.getUrlParameter)("roomId") : "";
var streamName = typeof (0, js_2.getUrlParameter)("streamName") == "string" ? (0, js_2.getUrlParameter)("streamName") : "";
var subscriberId = typeof (0, js_2.getUrlParameter)("subscriberId") == "string" ? (0, js_2.getUrlParameter)("subscriberId") : "";
var subscriberCode = typeof (0, js_2.getUrlParameter)("subscriberCode") == "string" ? (0, js_2.getUrlParameter)("subscriberCode") : "";
var join_publish_button = document.getElementById("join_publish_button");
join_publish_button === null || join_publish_button === void 0 ? void 0 : join_publish_button.addEventListener("click", joinRoom, false);
var stop_publish_button = document.getElementById("stop_publish_button");
stop_publish_button === null || stop_publish_button === void 0 ? void 0 : stop_publish_button.addEventListener("click", leaveRoom, false);
var turn_off_camera_button = document.getElementById("turn_off_camera_button");
turn_off_camera_button === null || turn_off_camera_button === void 0 ? void 0 : turn_off_camera_button.addEventListener("click", turnOffLocalCamera, false);
var turn_on_camera_button = document.getElementById("turn_on_camera_button");
turn_on_camera_button === null || turn_on_camera_button === void 0 ? void 0 : turn_on_camera_button.addEventListener("click", turnOnLocalCamera, false);
var mute_mic_button = document.getElementById("mute_mic_button");
mute_mic_button === null || mute_mic_button === void 0 ? void 0 : mute_mic_button.addEventListener("click", muteLocalMic, false);
var unmute_mic_button = document.getElementById("unmute_mic_button");
unmute_mic_button === null || unmute_mic_button === void 0 ? void 0 : unmute_mic_button.addEventListener("click", unmuteLocalMic, false);
var options = document.getElementById("options");
options === null || options === void 0 ? void 0 : options.addEventListener("click", toggleOptions, false);
var send = document.getElementById("send");
send === null || send === void 0 ? void 0 : send.addEventListener("click", sendData, false);
...
if (roomId != null && typeof roomId === "string") {
    roomNameBox === null || roomNameBox === void 0 ? void 0 : roomNameBox.setAttribute("value", roomId);
}
...
function handleCameraButtons() {
    if (isCameraOff) {
        turn_off_camera_button === null || turn_off_camera_button === void 0 ? void 0 : turn_off_camera_button.setAttribute("disabled", "true");
        turn_on_camera_button === null || turn_on_camera_button === void 0 ? void 0 : turn_on_camera_button.removeAttribute("disabled");
    }
    else {
        turn_off_camera_button === null || turn_off_camera_button === void 0 ? void 0 : turn_off_camera_button.removeAttribute("disabled");
        turn_on_camera_button === null || turn_on_camera_button === void 0 ? void 0 : turn_on_camera_button.setAttribute("disabled", "true");
    }
}
function handleMicButtons() {
    if (isMicMuted) {
        mute_mic_button === null || mute_mic_button === void 0 ? void 0 : mute_mic_button.setAttribute("disabled", "true");
        unmute_mic_button === null || unmute_mic_button === void 0 ? void 0 : unmute_mic_button.removeAttribute("disabled");
    }
    else {
        mute_mic_button === null || mute_mic_button === void 0 ? void 0 : mute_mic_button.removeAttribute("disabled");
        unmute_mic_button === null || unmute_mic_button === void 0 ? void 0 : unmute_mic_button.setAttribute("disabled", "true");
    }
}
...
function joinRoom() {
    ...
    webRTCAdaptor.joinRoom(roomNameBox === null || roomNameBox === void 0 ? void 0 : roomNameBox.value, publishStreamId, "multitrack");
}
function leaveRoom() {
    if (roomTimerId != -1) {
    ...
    let roomName = (roomNameBox === null || roomNameBox === void 0 ? void 0 : roomNameBox.value) != null ? roomNameBox.value : "";
...
function playVideo(obj) {
    ...
    var _a;
    var roomId = roomNameBox === null || roomNameBox === void 0 ? void 0 : roomNameBox.value;
    ...
    // @ts-ignore
    (_a = video.srcObject) === null || _a === void 0 ? void 0 : _a.addTrack(obj.track);
...
function createRemoteVideo(streamId) {
    ...
    (_a = document.getElementById("players")) === null || _a === void 0 ? void 0 : _a.appendChild(player);
}
function removeRemoteVideo(streamId) {
    ...
    if (video != null) {
        ...
        (_a = document.getElementById("players")) === null || _a === void 0 ? void 0 : _a.removeChild(player);
    }
}
function removeAllRemoteVideos() {
    ...
    var children = (_a = document.getElementById("players")) === null || _a === void 0 ? void 0 : _a.children;
    let i = 1;
    while (i < children.length) {
        (_b = document.getElementById("players")) === null || _b === void 0 ? void 0 : _b.removeChild(children[i]);
        i++;
    }
}
...
var websocketURL = (0, utils_js_1.getWebSocketURL)(location);
var isPlaying = false;
var webRTCAdaptor = new js_1.WebRTCAdaptor({
    ...
    callback: (info, obj) => {
        if (info == "initialized") {
            ...
            join_publish_button === null || join_publish_button === void 0 ? void 0 : join_publish_button.removeAttribute("disabled");
            stop_publish_button === null || stop_publish_button === void 0 ? void 0 : stop_publish_button.setAttribute("disabled", "true");
            if (playOnly) {
                isCameraOff = true;
                handleCameraButtons();
            }
            ...
            if (playOnly) {
                join_publish_button === null || join_publish_button === void 0 ? void 0 : join_publish_button.setAttribute("disabled", "true");
                stop_publish_button === null || stop_publish_button === void 0 ? void 0 : stop_publish_button.removeAttribute("disabled");
                isCameraOff = true;
                handleCameraButtons();
            }
            else {
            ...
            console.debug("publish started to room " + (roomNameBox === null || roomNameBox === void 0 ? void 0 : roomNameBox.value));
            join_publish_button === null || join_publish_button === void 0 ? void 0 : join_publish_button.setAttribute("disabled", "true");
            stop_publish_button === null || stop_publish_button === void 0 ? void 0 : stop_publish_button.removeAttribute("disabled");
            startAnimation();
            enableAudioLevel();
    ...
    callbackError: function (error, message) {
        ...
        if (error.indexOf("no_active_streams_in_room") != -1) {
            ...
            console.error("Warning: " + (0, utils_js_1.errorHandler)(error, message));
        }
    }
});
