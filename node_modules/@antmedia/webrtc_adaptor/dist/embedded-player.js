...
var _rollupPluginBabelHelpers = require('./_rollupPluginBabelHelpers-d12909e1.js');
var fetch_stream = require('./fetch.stream.js');
require('./loglevel.min-60c2530f.js');
...
class EmbeddedPlayer {
  constructor(window, containerElement, placeHolderElement) {
    ...
    */
    _rollupPluginBabelHelpers._defineProperty(this, "playOrder", void 0);
    /**
     * currentPlayType: current play type in playOrder
     */
    _rollupPluginBabelHelpers._defineProperty(this, "currentPlayType", void 0);
    /**
     * "is360": if true, player will be 360 degree player. Optional. Default value is false.
     * It will be taken from url parameter "is360".
     */
    _rollupPluginBabelHelpers._defineProperty(this, "is360", false);
    /**
     ...
     */
    _rollupPluginBabelHelpers._defineProperty(this, "streamId", void 0);
    /**
     ...
     */
    _rollupPluginBabelHelpers._defineProperty(this, "playType", void 0);
    /**
     * "token": token. It's required when stream security for playback is enabled .
     * It will be taken from url parameter "token".
     */
    _rollupPluginBabelHelpers._defineProperty(this, "token", void 0);
    /**
     ...
     */
    _rollupPluginBabelHelpers._defineProperty(this, "autoPlay", true);
    /**
     ...
     */
    _rollupPluginBabelHelpers._defineProperty(this, "mute", true);
    /**
     ...
     */
    _rollupPluginBabelHelpers._defineProperty(this, "targetLatency", 3);
    /**
     * subscriberId: subscriber id. Optional. It will be taken from url parameter "subscriberId".
     */
    _rollupPluginBabelHelpers._defineProperty(this, "subscriberId", void 0);
    /**
     * subscriberCode: subscriber code. Optional. It will be taken from url parameter "subscriberCode".
     */
    _rollupPluginBabelHelpers._defineProperty(this, "subscriberCode", void 0);
    /**
     * window: window object
     */
    _rollupPluginBabelHelpers._defineProperty(this, "window", void 0);
    /**
     * video player container element
     */
    _rollupPluginBabelHelpers._defineProperty(this, "containerElement", void 0);
    /**
     * player placeholder element
     */
    _rollupPluginBabelHelpers._defineProperty(this, "placeHolderElement", void 0);
    /**
     * videojs player
     */
    _rollupPluginBabelHelpers._defineProperty(this, "videojsPlayer", void 0);
    /**
     * dash player
     */
    _rollupPluginBabelHelpers._defineProperty(this, "dashPlayer", void 0);
    /**
     * Ice servers for webrtc
     */
    _rollupPluginBabelHelpers._defineProperty(this, "iceServers", void 0);
    /**
     * ice connection state
     */
    _rollupPluginBabelHelpers._defineProperty(this, "iceConnected", void 0);
    /**
     * flag to check if error callback is called
     */
    _rollupPluginBabelHelpers._defineProperty(this, "errorCalled", void 0);
    /**
     * scene for 360 degree player
     */
    _rollupPluginBabelHelpers._defineProperty(this, "aScene", void 0);
    /**
     * player listener
     */
    _rollupPluginBabelHelpers._defineProperty(this, "playerListener", void 0);
    /**
     * webRTCDataListener
     */
    _rollupPluginBabelHelpers._defineProperty(this, "webRTCDataListener", void 0);
    /**
     * Field to keep if tryNextMethod is already called
     */
    _rollupPluginBabelHelpers._defineProperty(this, "tryNextTechTimer", void 0);
    ...
    */
    ...
    this.window = window;
    var localStreamId = fetch_stream.getUrlParameter("id", this.window.location.search);
    ...
    if (localStreamId == null) {
      ...
      localStreamId = fetch_stream.getUrlParameter("name", this.window.location.search);
      if (localStreamId == null) {
    ...
    var localIs360 = fetch_stream.getUrlParameter("is360", this.window.location.search);
    if (localIs360 != null) {
      this.is360 = localIs360.toLocaleLowerCase() == "true";
    }
    var localPlayType = fetch_stream.getUrlParameter("playType", this.window.location.search);
    if (localPlayType != null) {
      this.playType = localPlayType.split(',');
    } else {
      this.playType = EmbeddedPlayer.DEFAULT_PLAY_TYPE;
    }
    this.token = fetch_stream.getUrlParameter("token", this.window.location.search);
    if (this.token === undefined) {
      this.token = null;
    }
    var localAutoPlay = fetch_stream.getUrlParameter("autoplay", this.window.location.search);
    if (localAutoPlay != null) {
      this.autoPlay = localAutoPlay.toLocaleLowerCase() == "true";
    }
    var localMute = fetch_stream.getUrlParameter("mute", this.window.location.search);
    if (localMute != null) {
    ...
    this.subscriberId = fetch_stream.getUrlParameter("subscriberId", this.window.location.search);
    if (this.subscriberId === undefined) {
      this.subscriberId = null;
    }
    this.subscriberCode = fetch_stream.getUrlParameter("subscriberCode", this.window.location.search);
    if (this.subscriberCode == null) {
      this.subscriberCode = null;
    }
    var playOrderParameter = fetch_stream.getUrlParameter("playOrder", this.window.location.search);
  ...
  playIfExists(tech) {
    var _this = this;
    return _rollupPluginBabelHelpers._asyncToGenerator(function* () {
...
_rollupPluginBabelHelpers._defineProperty(EmbeddedPlayer, "DEFAULT_PLAY_ORDER", ["webrtc", "hls"]);
_rollupPluginBabelHelpers._defineProperty(EmbeddedPlayer, "DEFAULT_PLAY_TYPE", ["mp4", "webm"]);
_rollupPluginBabelHelpers._defineProperty(EmbeddedPlayer, "HLS_EXTENSION", "m3u8");
_rollupPluginBabelHelpers._defineProperty(EmbeddedPlayer, "WEBRTC_EXTENSION", "webrtc");
_rollupPluginBabelHelpers._defineProperty(EmbeddedPlayer, "DASH_EXTENSION", "mpd");
/**
* streamsFolder: streams folder. Optional. Default value is "streams"
*/
_rollupPluginBabelHelpers._defineProperty(EmbeddedPlayer, "STREAMS_FOLDER", "streams");
_rollupPluginBabelHelpers._defineProperty(EmbeddedPlayer, "VIDEO_HTML", STATIC_VIDEO_HTML);
_rollupPluginBabelHelpers._defineProperty(EmbeddedPlayer, "VIDEO_PLAYER_ID", "video-player");
