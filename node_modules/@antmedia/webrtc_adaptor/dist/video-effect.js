...
var webrtc_adaptor = require('./webrtc_adaptor.js');
...
class VideoEffect {
  ...
  constructor(webRTCAdaptor) {
     ...
     */
    _rollupPluginBabelHelpers._classPrivateMethodInitSpec(this, _noEffect);
    _rollupPluginBabelHelpers._classPrivateFieldInitSpec(this, _virtualBackgroundImage, {
      writable: true,
      value: null
    });
  ...
  set virtualBackgroundImage(imageElement) {
    _rollupPluginBabelHelpers._classPrivateFieldSet(this, _virtualBackgroundImage, imageElement);
  }
  startFpsCalculation() {
    ...
    return _rollupPluginBabelHelpers._asyncToGenerator(function* () {
      ...
      if (effectName === VideoEffect.VIRTUAL_BACKGROUND || effectName === VideoEffect.BLUR_BACKGROUND) {
        ...
        if (currentEffectName === VideoEffect.DEEPAR) {
          ...
          yield _rollupPluginBabelHelpers._classPrivateMethodGet(_this3, _noEffect, _noEffect2).call(_this3);
        }
        ...
        return new Promise((resolve, reject) => {
          //Stop timer
          _this3.stopFpsCalculation();
          _rollupPluginBabelHelpers._classPrivateMethodGet(_this3, _noEffect, _noEffect2).call(_this3);
          resolve();
        });
      }
    })();
  ...
  onResults(results) {
    ...
    if (this.effectName == VideoEffect.BLUR_BACKGROUND) {
      ...
      this.drawVirtualBackground(results.image, results.segmentationMask, _rollupPluginBabelHelpers._classPrivateFieldGet(this, _virtualBackgroundImage));
    } else {
...
_rollupPluginBabelHelpers._defineProperty(VideoEffect, "DEEPAR", "deepar");
_rollupPluginBabelHelpers._defineProperty(VideoEffect, "VIRTUAL_BACKGROUND", "virtual-background");
_rollupPluginBabelHelpers._defineProperty(VideoEffect, "BLUR_BACKGROUND", "blur-background");
_rollupPluginBabelHelpers._defineProperty(VideoEffect, "NO_EFFECT", "no-effect");
_rollupPluginBabelHelpers._defineProperty(VideoEffect, "deepARModelList", ['flower_face', 'Ping_Pong']);
/**
 * @type {boolean}
 */
_rollupPluginBabelHelpers._defineProperty(VideoEffect, "DEBUG", false);
/**
...
_rollupPluginBabelHelpers._defineProperty(VideoEffect, "LOCATE_FILE_URL", "https://cdn.jsdelivr.net/npm/@mediapipe/selfie_segmentation");
_rollupPluginBabelHelpers._defineProperty(VideoEffect, "DEEP_AR_FOLDER_ROOT_URL", "https://cdn.jsdelivr.net/npm/deepar@4.0.3");
_rollupPluginBabelHelpers._defineProperty(VideoEffect, "DEEP_AR_EFFECTS_URL", "../js/external/deepar-effects/");
_rollupPluginBabelHelpers._defineProperty(VideoEffect, "DEEP_AR_EXTENSION", ".deepar");
webrtc_adaptor.WebRTCAdaptor.register(webrtcAdaptorInstance => {
