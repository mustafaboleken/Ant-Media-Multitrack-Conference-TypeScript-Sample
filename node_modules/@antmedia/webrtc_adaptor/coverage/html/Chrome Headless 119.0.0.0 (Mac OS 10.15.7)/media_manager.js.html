    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">42.29% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>225/532</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">39.36% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>124/315</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>42/106</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>224/529</span>
            </div>
...
<a name='L1516'></a><a href='#L1516'>1516</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >                        this.openStream({video: true, audio: false})</span>
...
&nbsp;
                    ...
                    else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="else path not taken" >E</span>if (stream.getAudioTracks().length &gt; 0)</span>
                    {
<span class="cstat-no" title="statement not covered" >                        return this.updateAudioTrack(stream, streamId, null).then(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
...
&nbsp;
    ...
    navigatorUserMedia(mediaConstraints, func, catch_error) {
		...
		if (mediaConstraints.video == "dummy" || mediaConstraints.audio == "dummy") {
			...
			<span class="missing-if-branch" title="else path not taken" >E</span>if (mediaConstraints.audio == "dummy") 
			{
...
<span class="cstat-no" title="statement not covered" >        return this.getMedia(this.mediaConstraints, streamId);</span>
    }
&nbsp;
    /**
     * Called by User
...
&nbsp;
        ...
        } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="else path not taken" >E</span>if (this.localStream != null) {</span>
...
<span class="cstat-no" title="statement not covered" >            this.localStream = stream;</span>
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.localVideo != null) {   //it can be null
<span class="cstat-no" title="statement not covered" >            this.localVideo.srcObject = this.localStream;</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (onEndedCallback != null) {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isMuted) {
...
&nbsp;
    ...
    updateLocalVideoStream(stream, onEndedCallback, stopDesktop) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (stopDesktop &amp;&amp; this.desktopStream != null) {
...
&nbsp;
        if (this.localStream != null &amp;&amp; this.localStream.getVideoTracks()[0] != null ) 
        {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (videoTrack != newVideoTrack) 
            {
	            this.localStream.removeTrack(videoTrack);
	            videoTrack.stop();		
	            this.localStream.addTrack(newVideoTrack);
            }
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.localStream != null) {
...
&nbsp;
    ...
    updateAudioTrack(stream, streamId, onEndedCallback) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (audioTrackSender) {
...
&nbsp;
    ...
    updateVideoTrack(stream, streamId, onEndedCallback, stopDesktop) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (videoTrackSender) 
        {
...
<span class="cstat-no" title="statement not covered" >                Logger.debug(error.name);</span>
    ...
    getBlackVideoTrack() {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.blackFrameTimer == null) {
            this.blackFrameTimer = setInterval(<span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >                this.getBlackVideoTrack();</span>
            }, 3000);
        }
...
&nbsp;
        ...
        {
            let choosenId;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (streamId != null || typeof streamId != "undefined") {
...
&nbsp;
    ...
    turnOnLocalCamera(streamId) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.localStream == null) {
