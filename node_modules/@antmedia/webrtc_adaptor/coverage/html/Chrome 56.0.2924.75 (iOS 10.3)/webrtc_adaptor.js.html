    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">50.16% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>304/606</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>136/324</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>44/128</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">50.24% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>303/603</span>
            </div>
...
<a name='L2038'></a><a href='#L2038'>2038</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
    ...
    publish(streamId, token, subscriberId, subscriberCode, streamName, mainTrack, metaData) {
        ...
        //If it started with playOnly mode and wants to publish now
            ...
            this.mediaManager.initLocalStream().then(() =&gt; {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (this.mediaManager.localStream != null) {
...
&nbsp;
     ...
     * @param {string} streamId : unique id for the stream that you want to get info about
     */
<span class="fstat-no" title="function not covered" >    re</span>questVideoTrackAssignments(streamId) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
     ...
     * @param {string} streamId : unique id for the stream that you want to get info about
     */
<span class="fstat-no" title="function not covered" >    ge</span>tBroadcastObject(streamId) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    up</span>dateStreamMetaData(streamId, metaData) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
...
<span class="cstat-no" title="statement not covered" >                obj.data = this.sanitizeHTML(obj.data)</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                Logger.debug("setLocalDescription:"+configuration.sdp);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                this.webSocketAdaptor.send(JSON.stringify(jsCmd));</span>
&nbsp;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (isTypeOffer) {
...
<span class="cstat-no" title="statement not covered" >                Logger.error("set remote description is failed with error: " + error);</span>
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (error.toString().indexOf("InvalidAccessError") &gt; -1 || error.toString().indexOf("setRemoteDescription") &gt; -1) {
                /**
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.remoteDescriptionSet[streamId] == true) {
...
&nbsp;
            stats.forEach(value =&gt; {
                //Logger.debug(value);
                <span class="missing-if-branch" title="if path not taken" >I</span>if (value.type == "inbound-rtp" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof value.kind != "undefined")</span> {
...
&nbsp;
&nbsp;
                } else <span class="missing-if-branch" title="if path not taken" >I</span>if (value.type == "outbound-rtp") {//TODO: SPLIT AUDIO AND VIDEO BITRATES
<span class="cstat-no" title="statement not covered" >                    if (value.kind == "audio") {</span>
...
<span class="cstat-no" title="statement not covered" >                        framesEncoded += value.framesEncoded;</span>
                ...
                } else <span class="missing-if-branch" title="if path not taken" >I</span>if (value.type == "track" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof value.kind != "undefined" </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >value.kind == "audio")</span> {
...
<span class="cstat-no" title="statement not covered" >                        audioJitterAverageDelay = value.jitterBufferDelay / value.jitterBufferEmittedCount;</span>
                ...
                } else <span class="missing-if-branch" title="if path not taken" >I</span>if (value.type == "track" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof value.kind != "undefined" </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >value.kind == "video")</span> {
...
<span class="cstat-no" title="statement not covered" >                        videoJitterAverageDelay = value.jitterBufferDelay / value.jitterBufferEmittedCount;</span>
                ...
                } else <span class="missing-if-branch" title="if path not taken" >I</span>if (value.type == "remote-inbound-rtp" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof value.kind != "undefined")</span> {
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                            audioJitter = value.jitter;</span>
                ...
                } else <span class="missing-if-branch" title="if path not taken" >I</span>if (value.type == "media-source") {
...
<span class="cstat-no" title="statement not covered" >                        fps = value.framesPerSecond;</span>
                ...
                else <span class="missing-if-branch" title="if path not taken" >I</span>if(value.type == "candidate-pair" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >value.state == "succeeded" </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >value.availableOutgoingBitrate !=undefined)</span>{
<span class="cstat-no" title="statement not covered" >                    availableOutgoingBitrate = value.availableOutgoingBitrate/1000</span>
                }
            });
&nbsp;
...
&nbsp;
    ...
    enableStats(streamId) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.remotePeerConnectionStats[streamId] == null) {
            this.remotePeerConnectionStats[streamId] = new PeerStats(streamId);
            this.remotePeerConnectionStats[streamId].timerId = setInterval(<span class="fstat-no" title="function not covered" >()</span> =&gt; {
    ...
    sendData(streamId, data) {
        ...
        if (this.remotePeerConnection[streamId] !== undefined) {
            ...
            if (dataChannel === undefined || dataChannel === null || typeof dataChannel === 'undefined') {
                ...
                return;
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (dataChannel.readyState !== 'open') {
...
&nbsp;
    ...
    getSender(streamId, type) {
        var sender = null;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.remotePeerConnection[streamId] != null) {
