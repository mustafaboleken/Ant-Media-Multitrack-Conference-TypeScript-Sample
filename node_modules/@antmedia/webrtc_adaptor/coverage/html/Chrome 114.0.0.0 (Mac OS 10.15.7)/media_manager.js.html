...
<head>
    <title>Code coverage report for media_manager.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> media_manager.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">25% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>124/496</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">21.35% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>63/295</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">21.64% </span>
                <span class="quiet">Functions</span>
                <span class='fraction'>21/97</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>124/493</span>
            </div>
...
<a name='L1391'></a><a href='#L1391'>1391</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {SoundMeter} from "./soundmeter.js"
...
&nbsp;
        ...
        this.callback = (info, obj) =&gt; {
            Logger.debug("Callback info: " + info + " object: " + typeof obj !== undefined ? JSON.stringify(obj) : <span class="branch-1 cbranch-no" title="branch not covered" >"")</span>;
		};
&nbsp;
		/**
		 * Default callback error implementation. It's overriden below if it exists
		 */
		this.callbackError = <span class="fstat-no" title="function not covered" >(e</span>rr) =&gt; {
...
&nbsp;
        ...
        for (var key in initialValues.userParameters) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (initialValues.userParameters.hasOwnProperty(key)) {
...
&nbsp;
        ...
        if (this.mediaConstraints) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.mediaConstraints.video == "camera") {
<span class="cstat-no" title="statement not covered" >                this.publishMode = "camera";</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.mediaConstraints.video == "screen") {
<span class="cstat-no" title="statement not covered" >                this.publishMode = "screen";</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.mediaConstraints.video == "screen+camera") {
<span class="cstat-no" title="statement not covered" >                this.publishMode = "screen+camera";</span>
            }
        } else <span class="missing-if-branch" title="else path not taken" >E</span>{
            //just define default values
<span class="cstat-no" title="statement not covered" >            this.mediaConstraints = {video: true, audio: true};</span>
        }
&nbsp;
...
&nbsp;
    ...
    initLocalStream() {
        ...
        } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="else path not taken" >E</span>if (typeof this.mediaConstraints.audio != "undefined" &amp;&amp; this.mediaConstraints.audio != false) {</span>
            // get only audio
            var media_audio_constraint = <span class="cstat-no" title="statement not covered" >{audio: this.mediaConstraints.audio};</span>
<span class="cstat-no" title="statement not covered" >            return this.navigatorUserMedia(media_audio_constraint, <span class="fstat-no" title="function not covered" >st</span>ream =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                return this.gotStream(stream);</span>
            }, true)
        } else {
            //neither video nor audio is requested
            //just return null stream
<span class="cstat-no" title="statement not covered" >            Logger.debug("no media requested, just return an empty stream");</span>
...
&nbsp;
    ...
    */
    checkWebRTCPermissions() {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!("WebSocket" in window)) {
<span class="cstat-no" title="statement not covered" >            Logger.debug("WebSocket not supported.");</span>
<span class="cstat-no" title="statement not covered" >            this.callbackError("WebSocketNotSupported");</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof navigator.mediaDevices == "undefined") {
<span class="cstat-no" title="statement not covered" >            Logger.debug("Cannot open camera and mic because of unsecure context. Please Install SSL(https)");</span>
<span class="cstat-no" title="statement not covered" >            this.callbackError("UnsecureContext");</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof navigator.mediaDevices == "undefined" || navigator.mediaDevices == undefined || navigator.mediaDevices == null) {
<span class="cstat-no" title="statement not covered" >            this.callbackError("getUserMediaIsNotAllowed");</span>
        }
    }
&nbsp;
    /*
...
&nbsp;
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (checkAudio == false &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.localStream == null)</span> {
<span class="cstat-no" title="statement not covered" >                Logger.debug("Audio input not found")</span>
<span class="cstat-no" title="statement not covered" >                Logger.debug("Retrying to get user media without audio")</span>
<span class="cstat-no" title="statement not covered" >                if (this.inputDeviceNotFoundLimit &lt; 2) {</span>
<span class="cstat-no" title="statement not covered" >                    if (checkVideo != false) {</span>
<span class="cstat-no" title="statement not covered" >                        this.openStream({video: true, audio: false}, this.mode)</span>
<span class="cstat-no" title="statement not covered" >                        this.inputDeviceNotFoundLimit++;</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        Logger.debug("Video input not found")</span>
<span class="cstat-no" title="statement not covered" >                        alert("There is no video or audio input")</span>
                    }
                } else {
<span class="cstat-no" title="statement not covered" >                    alert("No input device found, publish is not possible");</span>
                }
            }
            return deviceArray;
        }).catch(<span class="fstat-no" title="function not covered" >er</span>r =&gt; {
<span class="cstat-no" title="statement not covered" >            Logger.error("Cannot get devices -&gt; error name: " + err.name + ": " + err.message);</span>
...
&nbsp;
     ...
     */
    trackDeviceChange() {
        navigator.mediaDevices.ondevicechange = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >            this.getDevices();</span>
        }
    }
&nbsp;
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    se</span>tDesktopwithCameraSource(stream, streamId, onEndedCallback) {
<span class="cstat-no" title="statement not covered" >        this.desktopStream = stream;</span>
<span class="cstat-no" title="statement not covered" >        return this.navigatorUserMedia({video: true, audio: false}, <span class="fstat-no" title="function not covered" >ca</span>meraStream =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            this.smallVideoTrack = cameraStream.getVideoTracks()[0];</span>
&nbsp;
            //create a canvas element
            var canvas = <span class="cstat-no" title="statement not covered" >document.createElement("canvas");</span>
            var canvasContext = <span class="cstat-no" title="statement not covered" >canvas.getContext("2d");</span>
&nbsp;
            //create video element for screen
            //var screenVideo = document.getElementById('sourceVideo');
            var screenVideo = <span class="cstat-no" title="statement not covered" >document.createElement('video');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            screenVideo.srcObject = stream;</span>
<span class="cstat-no" title="statement not covered" >            screenVideo.play();</span>
            //create video element for camera
            var cameraVideo = <span class="cstat-no" title="statement not covered" >document.createElement('video');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            cameraVideo.srcObject = cameraStream;</span>
<span class="cstat-no" title="statement not covered" >            cameraVideo.play();</span>
            var canvasStream = <span class="cstat-no" title="statement not covered" >canvas.captureStream(15);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (onEndedCallback != null) {</span>
<span class="cstat-no" title="statement not covered" >                stream.getVideoTracks()[0].onended = <span class="fstat-no" title="function not covered" >fu</span>nction (event) {</span>
<span class="cstat-no" title="statement not covered" >                    onEndedCallback(event);</span>
                }
            }
            var promise;
<span class="cstat-no" title="statement not covered" >            if (this.localStream == null) {</span>
<span class="cstat-no" title="statement not covered" >                promise = this.gotStream(canvasStream);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                promise = this.updateVideoTrack(canvasStream, streamId, onended, null);</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            promise.then(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
&nbsp;
                //update the canvas
<span class="cstat-no" title="statement not covered" >                this.desktopCameraCanvasDrawerTimer = setInterval(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
                    //draw screen to canvas
<span class="cstat-no" title="statement not covered" >                    canvas.width = screenVideo.videoWidth;</span>
<span class="cstat-no" title="statement not covered" >                    canvas.height = screenVideo.videoHeight;</span>
<span class="cstat-no" title="statement not covered" >                    canvasContext.drawImage(screenVideo, 0, 0, canvas.width, canvas.height);</span>
&nbsp;
                    var cameraWidth = <span class="cstat-no" title="statement not covered" >screenVideo.videoWidth * (this.camera_percent / 100);</span>
                    var cameraHeight = <span class="cstat-no" title="statement not covered" >(cameraVideo.videoHeight / cameraVideo.videoWidth) * cameraWidth</span>
&nbsp;
                    var positionX = <span class="cstat-no" title="statement not covered" >(canvas.width - cameraWidth) - this.camera_margin;</span>
                    var positionY;
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (this.camera_location == "top") {</span>
<span class="cstat-no" title="statement not covered" >                        positionY = this.camera_margin;</span>
                    } else { //if not top, make it bottom
                        //draw camera on right bottom corner
<span class="cstat-no" title="statement not covered" >                        positionY = (canvas.height - cameraHeight) - this.camera_margin;</span>
                    }
<span class="cstat-no" title="statement not covered" >                    canvasContext.drawImage(cameraVideo, positionX, positionY, cameraWidth, cameraHeight);</span>
                }, 66);
            });
        }, true)
    }
&nbsp;
    ...
    prepareStreamTracks(mediaConstraints, audioConstraint, stream, streamId) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (audioTracks.length &gt; 0 &amp;&amp; this.publishMode == "camera") {
            audioTracks[0].stop();
...
&nbsp;
                ...
                var onended = <span class="fstat-no" title="function not covered" >ev</span>ent =&gt; {
<span class="cstat-no" title="statement not covered" >                    this.callback("screen_share_stopped");</span>
<span class="cstat-no" title="statement not covered" >                    this.setVideoCameraSource(streamId, mediaConstraints, null, true);</span>
                }
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (this.publishMode == "screen") {
<span class="cstat-no" title="statement not covered" >                    return this.updateVideoTrack(stream, streamId, onended, true).then(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                        if (audioTracks.length &gt; 0) { //system audio share case, then mix it with device audio</span>
<span class="cstat-no" title="statement not covered" >                            audioStream = this.mixAudioStreams(stream, audioStream);</span>
                        }
<span class="cstat-no" title="statement not covered" >                        return this.updateAudioTrack(audioStream, streamId, null);</span>
                    });
                } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.publishMode == "screen+camera") {
<span class="cstat-no" title="statement not covered" >                    if (audioTracks.length &gt; 0) { //system audio share case, then mix it with device audio</span>
<span class="cstat-no" title="statement not covered" >                        audioStream = this.mixAudioStreams(stream, audioStream);</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    return this.updateAudioTrack(audioStream, streamId, null).then(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                        return this.setDesktopwithCameraSource(stream, streamId, onended);</span>
                    });
&nbsp;
                } else {
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (audioConstraint != false &amp;&amp; audioConstraint != undefined) {
...
<span class="cstat-no" title="statement not covered" >            if (catch_error == true) {</span>
<span class="cstat-no" title="statement not covered" >                if (error.name == "NotFoundError") {</span>
<span class="cstat-no" title="statement not covered" >                    this.getDevices()</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    this.callbackError(error.name, error.message);</span>
                }
            } else {
...
&nbsp;
     ...
     * @param {*} func : callback on success. The stream which is got, is passed as parameter to this function
     */
<span class="fstat-no" title="function not covered" >    na</span>vigatorDisplayMedia(mediaConstraints, func) {
<span class="cstat-no" title="statement not covered" >        return navigator.mediaDevices.getDisplayMedia(mediaConstraints)</span>
            .then(<span class="fstat-no" title="function not covered" >(s</span>tream) =&gt; {
<span class="cstat-no" title="statement not covered" >                if (typeof func != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                    func(stream);</span>
                }
<span class="cstat-no" title="statement not covered" >                return stream;</span>
            })
            .catch(<span class="fstat-no" title="function not covered" >er</span>ror =&gt; {
<span class="cstat-no" title="statement not covered" >                if (error.name === "NotAllowedError") {</span>
<span class="cstat-no" title="statement not covered" >                    Logger.debug("Permission denied error");</span>
<span class="cstat-no" title="statement not covered" >                    this.callbackError("ScreenSharePermissionDenied");</span>
&nbsp;
                    // If error catched then redirect Default Stream Camera
<span class="cstat-no" title="statement not covered" >                    if (this.localStream == null) {</span>
                        var mediaConstraints = <span class="cstat-no" title="statement not covered" >{</span>
                            video: true,
                            audio: true
                        };
&nbsp;
<span class="cstat-no" title="statement not covered" >                        this.openStream(mediaConstraints);</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        this.switchVideoCameraCapture(streamId);</span>
                    }
                }
            });
    }
&nbsp;
    ...
    getMedia(mediaConstraints, audioConstraint, streamId) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.desktopCameraCanvasDrawerTimer != null) {
<span class="cstat-no" title="statement not covered" >            clearInterval(this.desktopCameraCanvasDrawerTimer);</span>
<span class="cstat-no" title="statement not covered" >            this.desktopCameraCanvasDrawerTimer = null;</span>
        }
&nbsp;
        // Check Media Constraint video value screen or screen + camera
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.publishMode == "screen+camera" || this.publishMode == "screen") {
<span class="cstat-no" title="statement not covered" >            return this.navigatorDisplayMedia(mediaConstraints).then(<span class="fstat-no" title="function not covered" >st</span>ream =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                if (this.smallVideoTrack)</span>
<span class="cstat-no" title="statement not covered" >                    this.smallVideoTrack.stop();</span>
<span class="cstat-no" title="statement not covered" >                return this.prepareStreamTracks(mediaConstraints, audioConstraint, stream, streamId);</span>
            });
        }
        // If mediaConstraints only user camera
        else {
            return this.navigatorUserMedia(mediaConstraints).then(stream =&gt; {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (this.smallVideoTrack)
<span class="cstat-no" title="statement not covered" >                    this.smallVideoTrack.stop();</span>
...
&nbsp;
    ...
    openStream(mediaConstraints) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof mediaConstraints.audio != "undefined" &amp;&amp; mediaConstraints.audio != false) {
...
<span class="cstat-no" title="statement not covered" >            return new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                this.callbackError("media_constraint_video_not_defined");</span>
<span class="cstat-no" title="statement not covered" >                Logger.error("MediaConstraint video is not defined");</span>
<span class="cstat-no" title="statement not covered" >                reject("media_constraint_video_not_defined");</span>
            });
        }
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (this.localStream) {</span>
<span class="cstat-no" title="statement not covered" >            this.localStream.getVideoTracks().forEach(<span class="fstat-no" title="function not covered" >fu</span>nction (track) {</span>
<span class="cstat-no" title="statement not covered" >                track.onended = null;</span>
<span class="cstat-no" title="statement not covered" >                track.stop();</span>
            });
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.localStream.getAudioTracks().forEach(<span class="fstat-no" title="function not covered" >fu</span>nction (track) {</span>
<span class="cstat-no" title="statement not covered" >                track.onended = null;</span>
<span class="cstat-no" title="statement not covered" >                track.stop();</span>
            });
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.videoTrack) {</span>
<span class="cstat-no" title="statement not covered" >            this.videoTrack.stop();</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.audioTrack) {</span>
<span class="cstat-no" title="statement not covered" >            this.audioTrack.stop();</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.smallVideoTrack) {</span>
<span class="cstat-no" title="statement not covered" >            this.smallVideoTrack.stop();</span>
        }
<span class="cstat-no" title="statement not covered" >        if (this.previousAudioTrack) {</span>
<span class="cstat-no" title="statement not covered" >            this.previousAudioTrack.stop();</span>
        }
<span class="cstat-no" title="statement not covered" >        if (this.soundLevelProviderId != -1) {</span>
<span class="cstat-no" title="statement not covered" >            clearInterval(this.soundLevelProviderId);</span>
<span class="cstat-no" title="statement not covered" >            this.soundLevelProviderId = -1;</span>
        }
    }
&nbsp;
&nbsp;
    ...
    checkBrowserScreenShareSupported() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if ((typeof navigator.mediaDevices != "undefined" &amp;&amp; navigator.mediaDevices.getDisplayMedia) || <span class="branch-2 cbranch-no" title="branch not covered" >navigator.getDisplayMedia)</span> {
...
&nbsp;
     ...
     * @param {*} enable
     */
<span class="fstat-no" title="function not covered" >    en</span>ableSecondStreamInMixedAudio(enable) {
<span class="cstat-no" title="statement not covered" >        if (this.secondaryAudioTrackGainNode != null) {</span>
<span class="cstat-no" title="statement not covered" >            if (enable) {</span>
<span class="cstat-no" title="statement not covered" >                this.secondaryAudioTrackGainNode.gain.value = 1;</span>
            } else {
<span class="cstat-no" title="statement not covered" >                this.secondaryAudioTrackGainNode.gain.value = 0;</span>
            }
        }
    }
&nbsp;
    ...
    gotStream(stream) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.localVideo) {
<span class="cstat-no" title="statement not covered" >            this.localVideo.srcObject = stream;</span>
        }
        this.getDevices();
...
&nbsp;
     ...
     * @param {*} videoEl
     */
<span class="fstat-no" title="function not covered" >    ch</span>angeLocalVideo(videoEl) {
<span class="cstat-no" title="statement not covered" >        this.localVideo = videoEl</span>
<span class="cstat-no" title="statement not covered" >        if (this.localStream) {</span>
<span class="cstat-no" title="statement not covered" >            this.localVideo.srcObject = this.localStream</span>
        }
    }
&nbsp;
    /**
...
<span class="cstat-no" title="statement not covered" >        navigator.mediaDevices.getUserMedia({video: false, audio: true})</span>
            .then(<span class="fstat-no" title="function not covered" >(s</span>tream) =&gt; {
<span class="cstat-no" title="statement not covered" >                this.mutedAudioStream = stream;</span>
<span class="cstat-no" title="statement not covered" >                this.mutedSoundMeter = new SoundMeter(this.audioContext);</span>
<span class="cstat-no" title="statement not covered" >                soundMeter.connectToSource(this.mutedAudioStream, <span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                    if (value &gt; 0.1) {</span>
<span class="cstat-no" title="statement not covered" >                        this.callback("speaking_but_muted");</span>
                    }
...
<span class="cstat-no" title="statement not covered" >                    this.meterRefresh = setInterval(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                        if (soundMeter.instant.toFixed(2) &gt; 0.1) {</span>
<span class="cstat-no" title="statement not covered" >                            this.callback("speaking_but_muted");</span>
                        }
                    }, 200);
                });
...
<span class="cstat-no" title="statement not covered" >                Logger.debug("Can't get the soundlevel on mute")</span>
            });
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    di</span>sableAudioLevelWhenMuted() {
<span class="cstat-no" title="statement not covered" >        if (this.meterRefresh != null) {</span>
<span class="cstat-no" title="statement not covered" >            clearInterval(this.meterRefresh);</span>
<span class="cstat-no" title="statement not covered" >            this.meterRefresh = null;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.mutedSoundMeter != null) {</span>
<span class="cstat-no" title="statement not covered" >            this.mutedSoundMeter.stop();</span>
<span class="cstat-no" title="statement not covered" >            this.mutedSoundMeter = null;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.mutedAudioStream != null) {</span>
<span class="cstat-no" title="statement not covered" >            this.mutedAudioStream.getTracks().forEach(<span class="fstat-no" title="function not covered" >fu</span>nction (track) {</span>
<span class="cstat-no" title="statement not covered" >                track.stop();</span>
            });
        }
    }
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    mi</span>xAudioStreams(stream, secondStream) {
        //Logger.debug("audio stream track count: " + audioStream.getAudioTracks().length);
        var composedStream = <span class="cstat-no" title="statement not covered" >new MediaStream();</span>
        //added the video stream from the screen
<span class="cstat-no" title="statement not covered" >        stream.getVideoTracks().forEach(<span class="fstat-no" title="function not covered" >fu</span>nction (videoTrack) {</span>
<span class="cstat-no" title="statement not covered" >            composedStream.addTrack(videoTrack);</span>
        });
&nbsp;
        var audioDestionation = <span class="cstat-no" title="statement not covered" >this.audioContext.createMediaStreamDestination();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (stream.getAudioTracks().length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >            this.primaryAudioTrackGainNode = this.audioContext.createGain();</span>
&nbsp;
            //Adjust the gain for screen sound
<span class="cstat-no" title="statement not covered" >            this.primaryAudioTrackGainNode.gain.value = 1;</span>
            var audioSource = <span class="cstat-no" title="statement not covered" >this.audioContext.createMediaStreamSource(stream);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            audioSource.connect(this.primaryAudioTrackGainNode).connect(audioDestionation);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            Logger.debug("Origin stream does not have audio track")</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (secondStream.getAudioTracks().length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >            this.secondaryAudioTrackGainNode = this.audioContext.createGain();</span>
&nbsp;
            //Adjust the gain for second sound
<span class="cstat-no" title="statement not covered" >            this.secondaryAudioTrackGainNode.gain.value = 1;</span>
&nbsp;
            var audioSource2 = <span class="cstat-no" title="statement not covered" >this.audioContext.createMediaStreamSource(secondStream);</span>
<span class="cstat-no" title="statement not covered" >            audioSource2.connect(this.secondaryAudioTrackGainNode).connect(audioDestionation);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            Logger.debug("Second stream does not have audio track")</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        audioDestionation.stream.getAudioTracks().forEach(<span class="fstat-no" title="function not covered" >fu</span>nction (track) {</span>
<span class="cstat-no" title="statement not covered" >            composedStream.addTrack(track);</span>
<span class="cstat-no" title="statement not covered" >            Logger.debug("audio destination add track");</span>
        });
&nbsp;
<span class="cstat-no" title="statement not covered" >        return composedStream;</span>
    }
&nbsp;
    /**
    ...
    setGainNodeStream(stream) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.mediaConstraints.audio != false &amp;&amp; typeof this.mediaConstraints.audio != "undefined") {
...
<span class="cstat-no" title="statement not covered" >                this.primaryAudioTrackGainNode.gain.value = this.currentVolume;</span>
            }
&nbsp;
            /**
...
<span class="cstat-no" title="statement not covered" >                controlledStream.addTrack(videoTrack);</span>
            }
            for (const audioTrack of audioTracks) {
                controlledStream.addTrack(audioTrack);
            }
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.previousAudioTrack !== null) {
<span class="cstat-no" title="statement not covered" >                this.previousAudioTrack.stop();</span>
            }
...
<span class="cstat-no" title="statement not covered" >        this.publishMode = "screen";</span>
&nbsp;
        var audioConstraint = <span class="cstat-no" title="statement not covered" >false;</span>
<span class="cstat-no" title="statement not covered" >        if (typeof this.mediaConstraints.audio != "undefined" &amp;&amp; this.mediaConstraints.audio != false) {</span>
<span class="cstat-no" title="statement not covered" >            audioConstraint = this.mediaConstraints.audio;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (typeof this.mediaConstraints.video != "undefined" &amp;&amp; this.mediaConstraints.video != false) {</span>
<span class="cstat-no" title="statement not covered" >            this.mediaConstraints.video = true</span>
        }
        //TODO: I don't think we need to get audio again. We just need to switch the video stream
<span class="cstat-no" title="statement not covered" >        return this.getMedia(this.mediaConstraints, audioConstraint, streamId);</span>
    }
&nbsp;
    /**
     * Called by User
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    up</span>dateLocalAudioStream(stream, onEndedCallback) {
        var newAudioTrack = <span class="cstat-no" title="statement not covered" >stream.getAudioTracks()[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.localStream != null &amp;&amp; this.localStream.getAudioTracks()[0] != null) {</span>
            var audioTrack = <span class="cstat-no" title="statement not covered" >this.localStream.getAudioTracks()[0];</span>
<span class="cstat-no" title="statement not covered" >            this.localStream.removeTrack(audioTrack);</span>
<span class="cstat-no" title="statement not covered" >            audioTrack.stop();</span>
<span class="cstat-no" title="statement not covered" >            this.localStream.addTrack(newAudioTrack);</span>
        } else <span class="cstat-no" title="statement not covered" >if (this.localStream != null) {</span>
<span class="cstat-no" title="statement not covered" >            this.localStream.addTrack(newAudioTrack);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            this.localStream = stream;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.localVideo != null) {   //it can be null</span>
<span class="cstat-no" title="statement not covered" >            this.localVideo.srcObject = this.localStream;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (onEndedCallback != null) {</span>
<span class="cstat-no" title="statement not covered" >            stream.getAudioTracks()[0].onended = <span class="fstat-no" title="function not covered" >fu</span>nction (event) {</span>
<span class="cstat-no" title="statement not covered" >                onEndedCallback(event);</span>
            }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.isMuted) {</span>
<span class="cstat-no" title="statement not covered" >            this.muteLocalMic();</span>
        } else {
<span class="cstat-no" title="statement not covered" >            this.unmuteLocalMic();</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.localStreamSoundMeter != null) {</span>
<span class="cstat-no" title="statement not covered" >            this.connectSoundMeterToLocalStream();</span>
        }
    }
&nbsp;
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    up</span>dateLocalVideoStream(stream, onEndedCallback, stopDesktop) {
<span class="cstat-no" title="statement not covered" >        if (stopDesktop &amp;&amp; this.desktopStream != null) {</span>
<span class="cstat-no" title="statement not covered" >            this.desktopStream.getVideoTracks()[0].stop();</span>
        }
&nbsp;
        var newVideoTrack = <span class="cstat-no" title="statement not covered" >stream.getVideoTracks()[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.localStream != null &amp;&amp; this.localStream.getVideoTracks()[0] != null) {</span>
            var videoTrack = <span class="cstat-no" title="statement not covered" >this.localStream.getVideoTracks()[0];</span>
<span class="cstat-no" title="statement not covered" >            this.localStream.removeTrack(videoTrack);</span>
<span class="cstat-no" title="statement not covered" >            videoTrack.stop();</span>
<span class="cstat-no" title="statement not covered" >            this.localStream.addTrack(newVideoTrack);</span>
        } else <span class="cstat-no" title="statement not covered" >if (this.localStream != null) {</span>
<span class="cstat-no" title="statement not covered" >            this.localStream.addTrack(newVideoTrack);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            this.localStream = stream;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.localVideo) {</span>
<span class="cstat-no" title="statement not covered" >            this.localVideo.srcObject = this.localStream;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (onEndedCallback != null) {</span>
...
<span class="fstat-no" title="function not covered" >    sw</span>itchAudioInputSource(streamId, deviceId) {
        ...
        var audioTrack = <span class="cstat-no" title="statement not covered" >this.localStream.getAudioTracks()[0];</span>
<span class="cstat-no" title="statement not covered" >        if (audioTrack) {</span>
<span class="cstat-no" title="statement not covered" >            audioTrack.stop();</span>
        } else {
<span class="cstat-no" title="statement not covered" >            Logger.warn("There is no audio track in local stream");</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (typeof deviceId != "undefined") {</span>
            //Update the media constraints
<span class="cstat-no" title="statement not covered" >            if (this.mediaConstraints.audio !== true)</span>
<span class="cstat-no" title="statement not covered" >                this.mediaConstraints.audio.deviceId = deviceId;</span>
            else
<span class="cstat-no" title="statement not covered" >                this.mediaConstraints.audio = {"deviceId": deviceId};</span>
&nbsp;
            //to change only audio track set video false otherwise issue #3826 occurs on Android
            let tempMediaConstraints = <span class="cstat-no" title="statement not covered" >{"video": false, "audio": {"deviceId": deviceId}};</span>
<span class="cstat-no" title="statement not covered" >            return this.setAudioInputSource(streamId, tempMediaConstraints, null, deviceId);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            return new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                reject("There is no device id for audio input source");</span>
            });
        }
    }
&nbsp;
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    se</span>tAudioInputSource(streamId, mediaConstraints, onEndedCallback) {
<span class="cstat-no" title="statement not covered" >        return this.navigatorUserMedia(mediaConstraints, <span class="fstat-no" title="function not covered" >st</span>ream =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            stream = this.setGainNodeStream(stream);</span>
<span class="cstat-no" title="statement not covered" >            return this.updateAudioTrack(stream, streamId, mediaConstraints, onEndedCallback);</span>
        }, true);
    }
&nbsp;
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    sw</span>itchVideoCameraCapture(streamId, deviceId, onEndedCallback) {
        //stop the track because in some android devices need to close the current camera stream
<span class="cstat-no" title="statement not covered" >        if (this.localStream &amp;&amp; this.localStream.getVideoTracks().length &gt; 0) {</span>
            var videoTrack = <span class="cstat-no" title="statement not covered" >this.localStream.getVideoTracks()[0];</span>
<span class="cstat-no" title="statement not covered" >            videoTrack.stop();</span>
        } else {
<span class="cstat-no" title="statement not covered" >            Logger.warn("There is no video track in local stream");</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.publishMode = "camera";</span>
<span class="cstat-no" title="statement not covered" >        return navigator.mediaDevices.enumerateDevices().then(<span class="fstat-no" title="function not covered" >de</span>vices =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; devices.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >                if (devices[i].kind == "videoinput") {</span>
...
<span class="cstat-no" title="statement not covered" >                    if (devices[i].deviceId == deviceId) {</span>
<span class="cstat-no" title="statement not covered" >                        if (this.mediaConstraints.video !== true)</span>
<span class="cstat-no" title="statement not covered" >                            this.mediaConstraints.video.deviceId = {exact: deviceId};</span>
                        else
<span class="cstat-no" title="statement not covered" >                            this.mediaConstraints.video = {deviceId: {exact: deviceId}};</span>
...
<span class="cstat-no" title="statement not covered" >            Logger.debug("Given deviceId = " + deviceId + " - Media constraints video property = " + this.mediaConstraints.video);</span>
<span class="cstat-no" title="statement not covered" >            return this.setVideoCameraSource(streamId, this.mediaConstraints, null, true, deviceId);</span>
        })
&nbsp;
    }
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    se</span>tVideoCameraSource(streamId, mediaConstraints, onEndedCallback, stopDesktop) {
<span class="cstat-no" title="statement not covered" >        return this.navigatorUserMedia(mediaConstraints, <span class="fstat-no" title="function not covered" >st</span>ream =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (stopDesktop &amp;&amp; this.secondaryAudioTrackGainNode &amp;&amp; stream.getAudioTracks().length &gt; 0) {</span>
...
<span class="cstat-no" title="statement not covered" >                this.secondaryAudioTrackGainNode = null;</span>
<span class="cstat-no" title="statement not covered" >                stream = this.setGainNodeStream(stream);</span>
<span class="cstat-no" title="statement not covered" >                this.updateAudioTrack(stream, streamId, mediaConstraints, onEndedCallback)</span>
&nbsp;
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (this.cameraEnabled) {</span>
<span class="cstat-no" title="statement not covered" >                return this.updateVideoTrack(stream, streamId, onEndedCallback, stopDesktop);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                return this.turnOffLocalCamera();</span>
            }
        }, true);
    }
&nbsp;
...
&nbsp;
        ...
        // so, remove device id
<span class="cstat-no" title="statement not covered" >        if (this.mediaConstraints.video !== undefined &amp;&amp; this.mediaConstraints.video.deviceId !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >            delete this.mediaConstraints.video.deviceId;</span>
        }
&nbsp;
        var videoConstraint = <span class="cstat-no" title="statement not covered" >{</span>
            'facingMode': facingMode
        };
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.mediaConstraints.video = Object.assign({},</span>
            this.mediaConstraints.video,
            videoConstraint);
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.publishMode = "camera";</span>
<span class="cstat-no" title="statement not covered" >        Logger.debug("Media constraints video property = " + this.mediaConstraints.video);</span>
<span class="cstat-no" title="statement not covered" >        return this.setVideoCameraSource(streamId, {video: this.mediaConstraints.video}, null, true);</span>
    }
&nbsp;
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    up</span>dateAudioTrack(stream, streamId, onEndedCallback) {
        var audioTrackSender = <span class="cstat-no" title="statement not covered" >this.getSender(streamId, "audio");</span>
<span class="cstat-no" title="statement not covered" >        if (audioTrackSender) {</span>
<span class="cstat-no" title="statement not covered" >            return audioTrackSender.replaceTrack(stream.getAudioTracks()[0]).then(<span class="fstat-no" title="function not covered" >re</span>sult =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                this.updateLocalAudioStream(stream, onEndedCallback);</span>
&nbsp;
            }).catch(<span class="fstat-no" title="function not covered" >fu</span>nction (error) {
<span class="cstat-no" title="statement not covered" >                Logger.debug(error.name);</span>
            });
        } else {
<span class="cstat-no" title="statement not covered" >            this.updateLocalAudioStream(stream, onEndedCallback);</span>
<span class="cstat-no" title="statement not covered" >            return new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve, reject) =&gt; {</span>
...
<span class="fstat-no" title="function not covered" >    up</span>dateVideoTrack(stream, streamId, onEndedCallback, stopDesktop) {
        var videoTrackSender = <span class="cstat-no" title="statement not covered" >this.getSender(streamId, "video");</span>
<span class="cstat-no" title="statement not covered" >        if (videoTrackSender) {</span>
<span class="cstat-no" title="statement not covered" >            return videoTrackSender.replaceTrack(stream.getVideoTracks()[0]).then(<span class="fstat-no" title="function not covered" >re</span>sult =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                this.updateLocalVideoStream(stream, onEndedCallback, stopDesktop);</span>
&nbsp;
            }).catch(<span class="fstat-no" title="function not covered" >er</span>ror =&gt; {
<span class="cstat-no" title="statement not covered" >                Logger.debug(error.name);</span>
            });
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    in</span>itializeDummyFrame() {
<span class="cstat-no" title="statement not covered" >        this.dummyCanvas.getContext('2d').fillRect(0, 0, 320, 240);</span>
<span class="cstat-no" title="statement not covered" >        this.replacementStream = this.dummyCanvas.captureStream();</span>
    }
&nbsp;
    /**
     * Called by User
...
<span class="cstat-no" title="statement not covered" >        this.initializeDummyFrame();</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (this.blackFrameTimer == null) {</span>
<span class="cstat-no" title="statement not covered" >            this.blackFrameTimer = setInterval(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                this.initializeDummyFrame();</span>
            }, 3000);
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.localStream != null) {</span>
            let choosenId;
<span class="cstat-no" title="statement not covered" >            if (streamId != null || typeof streamId != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                choosenId = streamId;</span>
            } else {
<span class="cstat-no" title="statement not covered" >                choosenId = this.publishStreamId;</span>
            }
<span class="cstat-no" title="statement not covered" >            this.cameraEnabled = false;</span>
<span class="cstat-no" title="statement not covered" >            return this.updateVideoTrack(this.replacementStream, choosenId, null, true);</span>
        } else {
&nbsp;
<span class="cstat-no" title="statement not covered" >            return new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                this.callbackError("NoActiveConnection");</span>
<span class="cstat-no" title="statement not covered" >                reject("NoActiveStream");</span>
            });
        }
&nbsp;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (this.blackFrameTimer != null) {</span>
<span class="cstat-no" title="statement not covered" >            clearInterval(this.blackFrameTimer);</span>
<span class="cstat-no" title="statement not covered" >            this.blackFrameTimer = null;</span>
        }
<span class="cstat-no" title="statement not covered" >        if (this.localStream == null) {</span>
<span class="cstat-no" title="statement not covered" >            return this.navigatorUserMedia(this.mediaConstraints, <span class="fstat-no" title="function not covered" >st</span>ream =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                this.gotStream(stream);</span>
            }, false);
        }
...
<span class="cstat-no" title="statement not covered" >                this.cameraEnabled = true;</span>
<span class="cstat-no" title="statement not covered" >                this.updateVideoTrack(stream, choosenId, null, true);</span>
            }, false);
        }
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        this.isMuted = true;</span>
<span class="cstat-no" title="statement not covered" >        if (this.localStream != null) {</span>
<span class="cstat-no" title="statement not covered" >            this.localStream.getAudioTracks().forEach(<span class="fstat-no" title="function not covered" >tr</span>ack =&gt; <span class="cstat-no" title="statement not covered" >track.enabled = false)</span>;</span>
        } else {
<span class="cstat-no" title="statement not covered" >            this.callbackError("NoActiveConnection");</span>
        }
    }
...
<span class="cstat-no" title="statement not covered" >        this.isMuted = false;</span>
<span class="cstat-no" title="statement not covered" >        if (this.localStream != null) {</span>
<span class="cstat-no" title="statement not covered" >            this.localStream.getAudioTracks().forEach(<span class="fstat-no" title="function not covered" >tr</span>ack =&gt; <span class="cstat-no" title="statement not covered" >track.enabled = true)</span>;</span>
        } else {
<span class="cstat-no" title="statement not covered" >            this.callbackError("NoActiveConnection");</span>
        }
    }
...
<span class="fstat-no" title="function not covered" >    ge</span>tVideoSender(streamId) {
        var videoSender = <span class="cstat-no" title="statement not covered" >null;</span>
<span class="cstat-no" title="statement not covered" >        if (typeof adapter !== "undefined" &amp;&amp; adapter !== null &amp;&amp; ((adapter.browserDetails.browser === 'chrome' ||</span>
                (adapter.browserDetails.browser === 'firefox' ||
                    adapter.browserDetails.browser === 'safari' &amp;&amp;
                    adapter.browserDetails.version &gt;= 64)) &amp;&amp;
            'RTCRtpSender' in window &amp;&amp;
            'setParameters' in window.RTCRtpSender.prototype)) {
<span class="cstat-no" title="statement not covered" >            videoSender = this.getSender(streamId, "video");</span>
&nbsp;
        }
<span class="cstat-no" title="statement not covered" >        return videoSender;</span>
    }
&nbsp;
    /**
     * Called by User
...
<span class="fstat-no" title="function not covered" >    ch</span>angeBandwidth(bandwidth, streamId) {
        var errorDefinition = <span class="cstat-no" title="statement not covered" >"";</span>
&nbsp;
        var videoSender = <span class="cstat-no" title="statement not covered" >this.getVideoSender(streamId);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (videoSender != null) {</span>
            const parameters = <span class="cstat-no" title="statement not covered" >videoSender.getParameters();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!parameters.encodings) {</span>
<span class="cstat-no" title="statement not covered" >                parameters.encodings = [{}];</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (bandwidth === 'unlimited') {</span>
<span class="cstat-no" title="statement not covered" >                delete parameters.encodings[0].maxBitrate;</span>
            } else {
<span class="cstat-no" title="statement not covered" >                parameters.encodings[0].maxBitrate = bandwidth * 1000;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            return videoSender.setParameters(parameters)</span>
        } else {
<span class="cstat-no" title="statement not covered" >            errorDefinition = "Video sender not found to change bandwidth. Streaming may not be active";</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return Promise.reject(errorDefinition);</span>
    };
&nbsp;
    /**
     * Called by user
...
<span class="cstat-no" title="statement not covered" >        this.currentVolume = volumeLevel;</span>
<span class="cstat-no" title="statement not covered" >        if (this.primaryAudioTrackGainNode != null) {</span>
<span class="cstat-no" title="statement not covered" >            this.primaryAudioTrackGainNode.gain.value = volumeLevel;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.secondaryAudioTrackGainNode != null) {</span>
<span class="cstat-no" title="statement not covered" >            this.secondaryAudioTrackGainNode.gain.value = volumeLevel;</span>
        }
    }
&nbsp;
    /**
    ...
    enableAudioLevelForLocalStream(levelCallback) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.audioContext.state !== 'running') {
<span class="cstat-no" title="statement not covered" >            return this.audioContext.resume().then(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                return this.localStreamSoundMeter.connectToSource(this.localStream, levelCallback);</span>
            })
        }
        else {
...
&nbsp;
     ...
     *
     */
<span class="fstat-no" title="function not covered" >    ap</span>plyConstraints(newConstraints) {
&nbsp;
        var constraints = <span class="cstat-no" title="statement not covered" >{};</span>
<span class="cstat-no" title="statement not covered" >        if (newConstraints.audio === undefined &amp;&amp; newConstraints.video === undefined) {</span>
            //if audio or video field is not defined, assume that it's a video constraint
<span class="cstat-no" title="statement not covered" >            constraints.video = newConstraints;</span>
<span class="cstat-no" title="statement not covered" >            this.mediaConstraints.video = Object.assign({},</span>
                this.mediaConstraints.video,
                constraints.video);
        } else <span class="cstat-no" title="statement not covered" >if (newConstraints.video !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >            constraints.video = newConstraints.video;</span>
<span class="cstat-no" title="statement not covered" >            this.mediaConstraints.video = Object.assign({},</span>
                this.mediaConstraints.video,
                constraints.video);
        }
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (newConstraints.audio !== undefined) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            constraints.audio = newConstraints.audio;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.mediaConstraints.audio = Object.assign({},</span>
                this.mediaConstraints.audio,
                constraints.audio);
        }
&nbsp;
&nbsp;
        var promise = <span class="cstat-no" title="statement not covered" >null;</span>
<span class="cstat-no" title="statement not covered" >        if (constraints.video !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >            if (this.localStream &amp;&amp; this.localStream.getVideoTracks().length &gt; 0) {</span>
                var videoTrack = <span class="cstat-no" title="statement not covered" >this.localStream.getVideoTracks()[0];</span>
<span class="cstat-no" title="statement not covered" >                promise = videoTrack.applyConstraints(this.mediaConstraints.video);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                promise = new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                    reject("There is no video track to apply constraints");</span>
                });
            }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (constraints.audio !== undefined) {</span>
...
<span class="cstat-no" title="statement not covered" >            promise = this.setAudioInputSource(this.publishStreamId, {audio: this.mediaConstraints.audio}, null);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.localStreamSoundMeter != null) {</span>
<span class="cstat-no" title="statement not covered" >            this.enableAudioLevelForLocalStream(this.levelCallback)</span>
        }
