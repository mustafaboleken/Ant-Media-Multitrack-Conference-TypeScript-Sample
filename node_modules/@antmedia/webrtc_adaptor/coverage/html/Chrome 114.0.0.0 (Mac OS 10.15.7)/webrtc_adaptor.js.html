...
<head>
    <title>Code coverage report for webrtc_adaptor.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> webrtc_adaptor.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">31.45% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>184/585</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">32.91% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>106/322</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">23.77% </span>
                <span class="quiet">Functions</span>
                <span class='fraction'>29/122</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">31.61% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>184/582</span>
            </div>
...
<a name='L1963'></a><a href='#L1963'>1963</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {PeerStats} from "./peer_stats.js"
...
class ReceivingMessage {
     ...
     * @param {number} size 
     */
<span class="fstat-no" title="function not covered" >    co</span>nstructor(size) {
<span class="cstat-no" title="statement not covered" >        this.size = size;</span>
<span class="cstat-no" title="statement not covered" >        this.received = 0;</span>
<span class="cstat-no" title="statement not covered" >        this.data = new ArrayBuffer(size);</span>
    }
}
&nbsp;
/**
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    st</span>atic register(pluginInitMethod) {
<span class="cstat-no" title="statement not covered" >        WebRTCAdaptor.pluginInitMethods.push(pluginInitMethod);</span>
    }
    /**
     * 
...
&nbsp;
        ...
        for (var key in initialValues) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (initialValues.hasOwnProperty(key)) {
...
&nbsp;
        ...
        this.mediaManager = new MediaManager({
            ...
            webRTCAdaptor: this,
&nbsp;
            callback: <span class="fstat-no" title="function not covered" >(i</span>nfo, obj) =&gt; {
<span class="cstat-no" title="statement not covered" >                this.notifyEventListeners(info, obj)</span>
            },
            callbackError: <span class="fstat-no" title="function not covered" >(e</span>rror, message) =&gt; {
<span class="cstat-no" title="statement not covered" >                this.notifyErrorEventListeners(error, message)</span>
            },
            getSender: <span class="fstat-no" title="function not covered" >(s</span>treamId, type) =&gt; {
<span class="cstat-no" title="statement not covered" >                return this.getSender(streamId, type)</span>
            },
        });
&nbsp;
...
&nbsp;
     ...
     */
    initPlugins() {
        WebRTCAdaptor.pluginInitMethods.forEach(<span class="fstat-no" title="function not covered" >(i</span>nitMethod) =&gt; {
<span class="cstat-no" title="statement not covered" >            initMethod(this);</span>
        });
    }
&nbsp;
    /**
     ...
     * @param {*} listener
     */
<span class="fstat-no" title="function not covered" >    ad</span>dEventListener(listener) {
<span class="cstat-no" title="statement not covered" >        this.eventListeners.push(listener);</span>
    }
&nbsp;
    /**
     ...
     * @param {*} errorListener
     */
<span class="fstat-no" title="function not covered" >    ad</span>dErrorEventListener(errorListener) {
<span class="cstat-no" title="statement not covered" >        this.errorEventListeners.push(errorListener);</span>
    }
&nbsp;
    /**
    ...
    notifyEventListeners(info, obj) {
        this.eventListeners.forEach(<span class="fstat-no" title="function not covered" >(l</span>istener) =&gt; {
<span class="cstat-no" title="statement not covered" >            listener(info, obj);</span>
        });
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.callback != null) {
<span class="cstat-no" title="statement not covered" >            this.callback(info, obj);</span>
        }
    }
&nbsp;
    /**
    ...
    notifyErrorEventListeners(error, message) {
        this.errorEventListeners.forEach(<span class="fstat-no" title="function not covered" >(l</span>istener) =&gt; {
<span class="cstat-no" title="statement not covered" >            listener(error, message);</span>
        });
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.callbackError != null) {
<span class="cstat-no" title="statement not covered" >            this.callbackError(error, message);</span>
        }
    }
&nbsp;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                Logger.warn(error);</span>
...
&nbsp;
    ...
    publish(streamId, token, subscriberId, subscriberCode, streamName, mainTrack, metaData) {
        ...
        else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.mediaManager.localStream == null) {
<span class="cstat-no" title="statement not covered" >            this.mediaManager.initLocalStream().then(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
                var videoEnabled = <span class="cstat-no" title="statement not covered" >false;</span>
                var audioEnabled = <span class="cstat-no" title="statement not covered" >false;</span>
<span class="cstat-no" title="statement not covered" >                if (this.mediaManager.localStream != null) {</span>
<span class="cstat-no" title="statement not covered" >                    videoEnabled = this.mediaManager.localStream.getVideoTracks().length &gt; 0 ? true : false;</span>
<span class="cstat-no" title="statement not covered" >                    audioEnabled = this.mediaManager.localStream.getAudioTracks().length &gt; 0 ? true : false;</span>
                }
<span class="cstat-no" title="statement not covered" >                this.sendPublishCommand(streamId, token, subscriberId, subscriberCode, streamName, mainTrack, metaData, videoEnabled, audioEnabled)</span>
&nbsp;
            }).catch(<span class="fstat-no" title="function not covered" >er</span>ror =&gt; {
<span class="cstat-no" title="statement not covered" >                Logger.warn(error);</span>
<span class="cstat-no" title="statement not covered" >                throw error;</span>
            ...
            var videoEnabled = this.mediaManager.localStream.getVideoTracks().length &gt; 0 ? true : <span class="branch-1 cbranch-no" title="branch not covered" >false;</span>
            var audioEnabled = this.mediaManager.localStream.getAudioTracks().length &gt; 0 ? true : <span class="branch-1 cbranch-no" title="branch not covered" >false;</span>
        ...
        setTimeout(() =&gt; {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.iceConnectionState(this.publishStreamId) != "checking" &amp;&amp; this.iceConnectionState(this.publishStreamId) != "connected" &amp;&amp; this.iceConnectionState(this.publishStreamId) != "completed") {
...
&nbsp;
    sendPublishCommand(streamId, token, subscriberId, subscriberCode, streamName, mainTrack, metaData, videoEnabled, audioEnabled) {
        var jsCmd = {
            ...
            streamId: streamId,
            token: token,
            subscriberId: (typeof subscriberId !== undefined &amp;&amp; subscriberId != null)  ? <span class="branch-0 cbranch-no" title="branch not covered" >subscriberId </span>: "",
            subscriberCode: (typeof subscriberCode !== undefined &amp;&amp; subscriberCode != null) ? <span class="branch-0 cbranch-no" title="branch not covered" >subscriberCode </span>: "",
            streamName: (typeof streamName !== undefined &amp;&amp; streamName != null) ? <span class="branch-0 cbranch-no" title="branch not covered" >streamName </span>: "",
            mainTrack: (typeof mainTrack !== undefined &amp;&amp; mainTrack != null) ? <span class="branch-0 cbranch-no" title="branch not covered" >mainTrack </span>: "",
            video: videoEnabled,
            audio: audioEnabled,
            metaData: (typeof metaData !== undefined  &amp;&amp; metaData != null) ? <span class="branch-0 cbranch-no" title="branch not covered" >metaData </span>: "",
        };
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    jo</span>inRoom(roomName, streamId, mode) {
<span class="cstat-no" title="statement not covered" >        this.roomName = roomName;</span>
&nbsp;
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
            command: "joinRoom",
            room: roomName,
            streamId: streamId,
            mode: mode,
        }
<span class="cstat-no" title="statement not covered" >        this.webSocketAdaptor.send(JSON.stringify(jsCmd));</span>
    }
&nbsp;
    /**
        ...
        var jsCmd =
            {
                command: "play",
                streamId: streamId,
                token: typeof token !== undefined &amp;&amp; token != null ? <span class="branch-0 cbranch-no" title="branch not covered" >token </span>: "",
                room: typeof roomId !== undefined &amp;&amp; roomId != null ? <span class="branch-0 cbranch-no" title="branch not covered" >roomId </span>: "",
                trackList: typeof enableTracks !== undefined &amp;&amp; enableTracks != null ? <span class="branch-0 cbranch-no" title="branch not covered" >enableTracks </span>: [],
                subscriberId: typeof subscriberId !== undefined &amp;&amp; subscriberId != null ? <span class="branch-0 cbranch-no" title="branch not covered" >subscriberId </span>: "",
                subscriberCode: typeof subscriberCode !== undefined &amp;&amp; subscriberId != null ? <span class="branch-0 cbranch-no" title="branch not covered" >subscriberCode </span>: "",
                viewerInfo: typeof metaData !== undefined &amp;&amp; metaData != null ? <span class="branch-0 cbranch-no" title="branch not covered" >metaData </span>: ""
            }
&nbsp;
        this.webSocketAdaptor.send(JSON.stringify(jsCmd));
&nbsp;
...
&nbsp;
        setTimeout(() =&gt; {
            //check if it is connected or not
            //this resolves if the server responds with some error message
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.iceConnectionState(streamId) != "checking" &amp;&amp;
...
&nbsp;
    ...
    {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.reconnectIfRequiredFlag)
        {
...
<span class="cstat-no" title="statement not covered" >                	this.tryAgain();</span>
            	}, delayMs);
			}
			else {
				this.tryAgain()
...
&nbsp;
	    ...
	    for (var index in this.playStreamId) 
	    {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.remotePeerConnection[streamId] != "null" &amp;&amp;
                //check connection status to not stop streaming an active stream
...
&nbsp;
    ...
    stop(streamId) {
        ...
        this.closePeerConnection(streamId);
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.webSocketAdaptor != null &amp;&amp; this.webSocketAdaptor.isConnected()) {
            var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
                command: "stop",
                streamId: streamId,
            };
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    jo</span>in(streamId) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
            command: "join",
            streamId: streamId,
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    on</span>Track(event, streamId)
    {
<span class="cstat-no" title="statement not covered" >        Logger.debug("onTrack for stream");</span>
<span class="cstat-no" title="statement not covered" >        if (this.remoteVideo != null) {</span>
<span class="cstat-no" title="statement not covered" >            if (this.remoteVideo.srcObject !== event.streams[0]) {</span>
<span class="cstat-no" title="statement not covered" >                this.remoteVideo.srcObject = event.streams[0];</span>
<span class="cstat-no" title="statement not covered" >                Logger.debug('Received remote stream');</span>
            }
        }
        else {
            var dataObj = <span class="cstat-no" title="statement not covered" >{</span>
                stream: event.streams[0],
                track: event.track,
                streamId: streamId,
                trackId: this.idMapping[streamId][event.transceiver.mid],
            }
<span class="cstat-no" title="statement not covered" >            this.notifyEventListeners("newTrackAvailable", dataObj);</span>
&nbsp;
            //deprecated. Listen newTrackAvailable in callback. It's kept for backward compatibility
<span class="cstat-no" title="statement not covered" >            this.notifyEventListeners("newStreamAvailable", dataObj);</span>
&nbsp;
        }
    }
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    le</span>aveFromRoom(roomName) {
<span class="cstat-no" title="statement not covered" >        for (var key in this.remotePeerConnection) {</span>
<span class="cstat-no" title="statement not covered" >            this.closePeerConnection(key);</span>
        }
<span class="cstat-no" title="statement not covered" >        this.roomName = roomName;</span>
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
...
<span class="cstat-no" title="statement not covered" >        Logger.debug("leave request is sent for " + roomName);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.webSocketAdaptor.send(JSON.stringify(jsCmd));</span>
    }
&nbsp;
     ...
     * @param {string} streamId : unique id for the peer-to-peer session
     */
<span class="fstat-no" title="function not covered" >    le</span>ave(streamId) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
            command: "leave",
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.webSocketAdaptor.send(JSON.stringify(jsCmd));</span>
<span class="cstat-no" title="statement not covered" >        this.closePeerConnection(streamId);</span>
<span class="cstat-no" title="statement not covered" >        this.multiPeerStreamId = null;</span>
    }
&nbsp;
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    ge</span>tStreamInfo(streamId) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    up</span>ateStreamMetaData(streamId, metaData) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    ge</span>tRoomInfo(roomName, streamId) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
            command: "getRoomInfo",
            streamId: streamId,
            room: roomName,
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    en</span>ableTrack(mainTrackId, trackId, enabled) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
            command: "enableTrack",
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    ge</span>tTracks(streamId, token) {
<span class="cstat-no" title="statement not covered" >        this.playStreamId.push(streamId);</span>
        var jsCmd =
...
&nbsp;
     ...
     *     streamId: unique id for the stream
     */
<span class="fstat-no" title="function not covered" >    ic</span>eCandidateReceived(event, streamId) {
<span class="cstat-no" title="statement not covered" >        if (event.candidate) {</span>
&nbsp;
            var protocolSupported = <span class="cstat-no" title="statement not covered" >false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (event.candidate.candidate == "") {</span>
                //event candidate can be received and its value can be "".
                //don't compare the protocols
<span class="cstat-no" title="statement not covered" >                protocolSupported = true;</span>
            } else <span class="cstat-no" title="statement not covered" >if (typeof event.candidate.protocol == "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                this.candidateTypes.forEach(<span class="fstat-no" title="function not covered" >el</span>ement =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                    if (event.candidate.candidate.toLowerCase().includes(element)) {</span>
<span class="cstat-no" title="statement not covered" >                        protocolSupported = true;</span>
                    }
                });
            } else {
<span class="cstat-no" title="statement not covered" >                protocolSupported = this.candidateTypes.includes(event.candidate.protocol.toLowerCase());</span>
            }
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (protocolSupported) {</span>
&nbsp;
                var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
...
<span class="cstat-no" title="statement not covered" >                    Logger.debug("sending ice candiate for stream Id " + streamId);</span>
<span class="cstat-no" title="statement not covered" >                    Logger.debug(JSON.stringify(event.candidate));</span>
                }
<span class="cstat-no" title="statement not covered" >                this.webSocketAdaptor.send(JSON.stringify(jsCmd));</span>
            } else {
<span class="cstat-no" title="statement not covered" >                Logger.debug("Candidate's protocol(full sdp: " + event.candidate.candidate + ") is not supported. Supported protocols: " + this.candidateTypes);</span>
<span class="cstat-no" title="statement not covered" >                if (event.candidate.candidate != "") { //</span>
<span class="cstat-no" title="statement not covered" >                    this.notifyErrorEventListeners("protocol_not_supported", "Support protocols: " + this.candidateTypes.toString() + " candidate: " + event.candidate.candidate);</span>
                }
            }
        } else {
<span class="cstat-no" title="statement not covered" >            Logger.debug("No event.candidate in the iceCandidate event");</span>
        }
    }
&nbsp;
    /**
    ...
    initDataChannel(streamId, dataChannel) {
        dataChannel.onerror = <span class="fstat-no" title="function not covered" >(e</span>rror) =&gt; {
<span class="cstat-no" title="statement not covered" >            Logger.debug("Data Channel Error:", error);</span>
            var obj = <span class="cstat-no" title="statement not covered" >{</span>
                streamId: streamId,
                error: error
            };
<span class="cstat-no" title="statement not covered" >            Logger.debug("channel status: ", dataChannel.readyState);</span>
<span class="cstat-no" title="statement not covered" >            if (dataChannel.readyState != "closed") {</span>
<span class="cstat-no" title="statement not covered" >                this.notifyErrorEventListeners("data_channel_error", obj);</span>
            }
        };
&nbsp;
        dataChannel.onmessage = <span class="fstat-no" title="function not covered" >(e</span>vent) =&gt; {
            var obj = <span class="cstat-no" title="statement not covered" >{</span>
                streamId: streamId,
                data: event.data,
            };
&nbsp;
            var data = <span class="cstat-no" title="statement not covered" >obj.data;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (typeof data === 'string' || data instanceof String) {</span>
<span class="cstat-no" title="statement not covered" >                this.notifyEventListeners("data_received", obj);</span>
            } else {
                var length = <span class="cstat-no" title="statement not covered" >data.length || data.size || data.byteLength;</span>
&nbsp;
                var view = <span class="cstat-no" title="statement not covered" >new Int32Array(data, 0, 1);</span>
                var token = <span class="cstat-no" title="statement not covered" >view[0];</span>
&nbsp;
                var msg = <span class="cstat-no" title="statement not covered" >this.receivingMessages[token];</span>
<span class="cstat-no" title="statement not covered" >                if (msg == undefined) {</span>
                    var view = <span class="cstat-no" title="statement not covered" >new Int32Array(data, 0, 2);</span>
                    var size = <span class="cstat-no" title="statement not covered" >view[1];</span>
<span class="cstat-no" title="statement not covered" >                    msg = new ReceivingMessage(size);</span>
<span class="cstat-no" title="statement not covered" >                    this.receivingMessages[token] = msg;</span>
<span class="cstat-no" title="statement not covered" >                    if (length &gt; 8) {</span>
<span class="cstat-no" title="statement not covered" >                        Logger.debug("something went wrong in msg receiving");</span>
                    }
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
&nbsp;
                var rawData = <span class="cstat-no" title="statement not covered" >data.slice(4, length);</span>
&nbsp;
                var dataView = <span class="cstat-no" title="statement not covered" >new Uint8Array(msg.data);</span>
<span class="cstat-no" title="statement not covered" >                dataView.set(new Uint8Array(rawData), msg.received, length - 4);</span>
<span class="cstat-no" title="statement not covered" >                msg.received += length - 4;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (msg.size == msg.received) {</span>
<span class="cstat-no" title="statement not covered" >                    obj.data = msg.data;</span>
<span class="cstat-no" title="statement not covered" >                    this.notifyEventListeners("data_received", obj);</span>
                }
            }
        };
&nbsp;
        dataChannel.onopen = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnection[streamId].dataChannel = dataChannel;</span>
<span class="cstat-no" title="statement not covered" >            Logger.debug("Data channel is opened");</span>
<span class="cstat-no" title="statement not covered" >            this.notifyEventListeners("data_channel_opened", streamId)</span>
        };
&nbsp;
        dataChannel.onclose = () =&gt; {
        ...
        if (this.remotePeerConnection[streamId] == null) {
            ...
            if (!this.playStreamId.includes(streamId)) {
                if (this.mediaManager.localStream != null) {
                    ...
                    this.mediaManager.localStream.getTracks().forEach(<span class="fstat-no" title="function not covered" >tr</span>ack =&gt; <span class="cstat-no" title="statement not covered" >this.remotePeerConnection[streamId].addTrack(track, this.mediaManager.localStream))</span>;
                }
            }
            this.remotePeerConnection[streamId].onicecandidate = <span class="fstat-no" title="function not covered" >ev</span>ent =&gt; {
<span class="cstat-no" title="statement not covered" >                this.iceCandidateReceived(event, closedStreamId);</span>
            }
            this.remotePeerConnection[streamId].ontrack = <span class="fstat-no" title="function not covered" >ev</span>ent =&gt; {
<span class="cstat-no" title="statement not covered" >                this.onTrack(event, closedStreamId);</span>
            }
&nbsp;
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.dataChannelEnabled) {
...
<span class="cstat-no" title="statement not covered" >                        Logger.warn("CreateDataChannel is not supported");</span>
                    }
&nbsp;
                } else if (dataChannelMode == "play") {
                    //in play mode, server opens the data channel
                    this.remotePeerConnection[streamId].ondatachannel = <span class="fstat-no" title="function not covered" >ev</span> =&gt; {
<span class="cstat-no" title="statement not covered" >                        this.initDataChannel(streamId, ev.channel);</span>
                    };
                } else <span class="missing-if-branch" title="else path not taken" >E</span>{
                    //for peer mode do both for now
                    const dataChannelOptions = <span class="cstat-no" title="statement not covered" >{</span>
                        ordered: true,
                    };
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (this.remotePeerConnection[streamId].createDataChannel) {</span>
                        var dataChannelPeer = <span class="cstat-no" title="statement not covered" >this.remotePeerConnection[streamId].createDataChannel(streamId, dataChannelOptions);</span>
<span class="cstat-no" title="statement not covered" >                        this.initDataChannel(streamId, dataChannelPeer);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                        this.remotePeerConnection[streamId].ondatachannel = <span class="fstat-no" title="function not covered" >ev</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                            this.initDataChannel(streamId, ev.channel);</span>
                        };
                    } else {
<span class="cstat-no" title="statement not covered" >                        Logger.warn("CreateDataChannel is not supported");</span>
...
&nbsp;
            this.remotePeerConnection[streamId].oniceconnectionstatechange = <span class="fstat-no" title="function not covered" >ev</span>ent =&gt; {
                var obj = <span class="cstat-no" title="statement not covered" >{state: this.remotePeerConnection[streamId].iceConnectionState, streamId: streamId};</span>
<span class="cstat-no" title="statement not covered" >                if (obj.state == "failed" || obj.state == "disconnected" || obj.state == "closed") {</span>
<span class="cstat-no" title="statement not covered" >                    this.reconnectIfRequired(3000);</span>
                }
<span class="cstat-no" title="statement not covered" >                this.notifyEventListeners("ice_connection_state_changed", obj);</span>
&nbsp;
                //
<span class="cstat-no" title="statement not covered" >                if (!this.isPlayMode &amp;&amp; !this.playStreamId.includes(streamId)) {</span>
<span class="cstat-no" title="statement not covered" >                    if (this.remotePeerConnection[streamId].iceConnectionState == "connected") {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                        this.mediaManager.changeBandwidth(this.mediaManager.bandwidth, streamId).then(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                            Logger.debug("Bandwidth is changed to " + this.mediaManager.bandwidth);</span>
                        })
                            .catch(<span class="fstat-no" title="function not covered" >e </span>=&gt; <span class="cstat-no" title="statement not covered" >Logger.warn(e))</span>;
                    }
                }
            }
&nbsp;
...
&nbsp;
    ...
    closePeerConnection(streamId) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (peerConnection != null) {
            this.remotePeerConnection[streamId] = null;
            delete this.remotePeerConnection[streamId];
            <span class="missing-if-branch" title="if path not taken" >I</span>if (peerConnection.dataChannel != null) {
<span class="cstat-no" title="statement not covered" >                peerConnection.dataChannel.close();</span>
            }
            <span class="missing-if-branch" title="else path not taken" >E</span>if (peerConnection.signalingState != "closed") {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.remotePeerConnectionStats[streamId] != null) {
<span class="cstat-no" title="statement not covered" >            clearInterval(this.remotePeerConnectionStats[streamId].timerId);</span>
<span class="cstat-no" title="statement not covered" >            delete this.remotePeerConnectionStats[streamId];</span>
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.soundMeters[streamId] != null) {
<span class="cstat-no" title="statement not covered" >            delete this.soundMeters[streamId];</span>
        }
    }
&nbsp;
    /**
     ...
     * @param {string} streamId: unique id for the stream
     */
<span class="fstat-no" title="function not covered" >    si</span>gnallingState(streamId) {
<span class="cstat-no" title="statement not covered" >        if (this.remotePeerConnection[streamId] != null) {</span>
<span class="cstat-no" title="statement not covered" >            return this.remotePeerConnection[streamId].signalingState;</span>
        }
...
&nbsp;
     ...
     * @param {string} streamId: unique id for the stream
     */
<span class="fstat-no" title="function not covered" >    go</span>tDescription(configuration, streamId) {
<span class="cstat-no" title="statement not covered" >        this.remotePeerConnection[streamId]</span>
            .setLocalDescription(configuration)
            .then(<span class="fstat-no" title="function not covered" >re</span>sponose =&gt; {
<span class="cstat-no" title="statement not covered" >                Logger.debug("Set local description successfully for stream Id " + streamId);</span>
&nbsp;
                var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (this.debug) {</span>
<span class="cstat-no" title="statement not covered" >                    Logger.debug("local sdp: ");</span>
<span class="cstat-no" title="statement not covered" >                    Logger.debug(configuration.sdp);</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                this.webSocketAdaptor.send(JSON.stringify(jsCmd));</span>
&nbsp;
            }).catch(<span class="fstat-no" title="function not covered" >(e</span>rror) =&gt; {
<span class="cstat-no" title="statement not covered" >            Logger.error("Cannot set local description. Error is: " + error);</span>
        });
    }
&nbsp;
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    ta</span>keConfiguration(idOfStream, configuration, typeOfConfiguration, idMapping) {
        var streamId = <span class="cstat-no" title="statement not covered" >idOfStream</span>
        var type = <span class="cstat-no" title="statement not covered" >typeOfConfiguration;</span>
        var conf = <span class="cstat-no" title="statement not covered" >configuration;</span>
        var isTypeOffer = (<span class="cstat-no" title="statement not covered" >type == "offer")</span>;
&nbsp;
        var dataChannelMode = <span class="cstat-no" title="statement not covered" >"publish";</span>
<span class="cstat-no" title="statement not covered" >        if (isTypeOffer) {</span>
<span class="cstat-no" title="statement not covered" >            dataChannelMode = "play";</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.idMapping[streamId] = idMapping;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.initPeerConnection(streamId, dataChannelMode);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.remotePeerConnection[streamId].setRemoteDescription(new RTCSessionDescription({</span>
            sdp: conf,
            type: type
        })).then(<span class="fstat-no" title="function not covered" >re</span>sponse =&gt; {
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (this.debug) {</span>
<span class="cstat-no" title="statement not covered" >                Logger.debug("set remote description is succesfull with response: " + response + " for stream : "</span>
                    + streamId + " and type: " + type);
<span class="cstat-no" title="statement not covered" >                Logger.debug(conf);</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.remoteDescriptionSet[streamId] = true;</span>
            var length = <span class="cstat-no" title="statement not covered" >this.iceCandidateList[streamId].length;</span>
<span class="cstat-no" title="statement not covered" >            Logger.debug("Ice candidate list size to be added: " + length);</span>
<span class="cstat-no" title="statement not covered" >            for (var i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; length; i++) {</span>
<span class="cstat-no" title="statement not covered" >                this.addIceCandidate(streamId, this.iceCandidateList[streamId][i]);</span>
            }
<span class="cstat-no" title="statement not covered" >            this.iceCandidateList[streamId] = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (isTypeOffer) {</span>
                //SDP constraints may be different in play mode
<span class="cstat-no" title="statement not covered" >                Logger.debug("try to create answer for stream id: " + streamId);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                this.remotePeerConnection[streamId].createAnswer(this.sdp_constraints)</span>
                    .then(<span class="fstat-no" title="function not covered" >co</span>nfiguration =&gt; {
<span class="cstat-no" title="statement not covered" >                        Logger.debug("created answer for stream id: " + streamId);</span>
                        //support for stereo
<span class="cstat-no" title="statement not covered" >                        configuration.sdp = configuration.sdp.replace("useinbandfec=1", "useinbandfec=1; stereo=1");</span>
<span class="cstat-no" title="statement not covered" >                        this.gotDescription(configuration, streamId);</span>
                    })
                    .catch(<span class="fstat-no" title="function not covered" >(e</span>rror) =&gt; {
<span class="cstat-no" title="statement not covered" >                        Logger.error("create answer error :" + error);</span>
                    });
            }
&nbsp;
        }).catch(<span class="fstat-no" title="function not covered" >(e</span>rror) =&gt; {
<span class="cstat-no" title="statement not covered" >            if (this.debug) {</span>
<span class="cstat-no" title="statement not covered" >                Logger.error("set remote description is failed with error: " + error);</span>
            }
<span class="cstat-no" title="statement not covered" >            if (error.toString().indexOf("InvalidAccessError") &gt; -1 || error.toString().indexOf("setRemoteDescription") &gt; -1) {</span>
                /**
                 * This error generally occurs in codec incompatibility.
                 * AMS for a now supports H.264 codec. This error happens when some browsers try to open it from VP8.
                 */
<span class="cstat-no" title="statement not covered" >                this.notifyErrorEventListeners("notSetRemoteDescription");</span>
            }
        });
&nbsp;
    }
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    ta</span>keCandidate(idOfTheStream, tmpLabel, tmpCandidate) {
        var streamId = <span class="cstat-no" title="statement not covered" >idOfTheStream;</span>
        var label = <span class="cstat-no" title="statement not covered" >tmpLabel;</span>
        var candidateSdp = <span class="cstat-no" title="statement not covered" >tmpCandidate;</span>
&nbsp;
        var candidate = <span class="cstat-no" title="statement not covered" >new RTCIceCandidate({</span>
            sdpMLineIndex: label,
            candidate: candidateSdp
        });
&nbsp;
        var dataChannelMode = <span class="cstat-no" title="statement not covered" >"peer";</span>
<span class="cstat-no" title="statement not covered" >        this.initPeerConnection(streamId, dataChannelMode);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.remoteDescriptionSet[streamId] == true) {</span>
<span class="cstat-no" title="statement not covered" >            this.addIceCandidate(streamId, candidate);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            Logger.debug("Ice candidate is added to list because remote description is not set yet");</span>
<span class="cstat-no" title="statement not covered" >            this.iceCandidateList[streamId].push(candidate);</span>
        }
    };
&nbsp;
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    ad</span>dIceCandidate(streamId, candidate) {
        var protocolSupported = <span class="cstat-no" title="statement not covered" >false;</span>
<span class="cstat-no" title="statement not covered" >        if (candidate.candidate == "") {</span>
            //candidate can be received and its value can be "".
            //don't compare the protocols
<span class="cstat-no" title="statement not covered" >            protocolSupported = true;</span>
        } else <span class="cstat-no" title="statement not covered" >if (typeof candidate.protocol == "undefined") {</span>
<span class="cstat-no" title="statement not covered" >            this.candidateTypes.forEach(<span class="fstat-no" title="function not covered" >el</span>ement =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                if (candidate.candidate.toLowerCase().includes(element)) {</span>
<span class="cstat-no" title="statement not covered" >                    protocolSupported = true;</span>
                }
            });
        } else {
<span class="cstat-no" title="statement not covered" >            protocolSupported = this.candidateTypes.includes(candidate.protocol.toLowerCase());</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (protocolSupported) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnection[streamId].addIceCandidate(candidate)</span>
                .then(<span class="fstat-no" title="function not covered" >re</span>sponse =&gt; {
<span class="cstat-no" title="statement not covered" >                    if (this.debug) {</span>
<span class="cstat-no" title="statement not covered" >                        Logger.debug("Candidate is added for stream " + streamId);</span>
                    }
                })
                .catch(<span class="fstat-no" title="function not covered" >(e</span>rror) =&gt; {
<span class="cstat-no" title="statement not covered" >                    Logger.error("ice candiate cannot be added for stream id: " + streamId + " error is: " + error);</span>
<span class="cstat-no" title="statement not covered" >                    Logger.error(candidate);</span>
                });
        } else {
<span class="cstat-no" title="statement not covered" >            if (this.debug) {</span>
<span class="cstat-no" title="statement not covered" >                Logger.debug("Candidate's protocol(" + candidate.protocol + ") is not supported." +</span>
...
&nbsp;
     ...
     * @param {string} idOfStream: unique id for the stream
     */
<span class="fstat-no" title="function not covered" >    st</span>artPublishing(idOfStream) {
        var streamId = <span class="cstat-no" title="statement not covered" >idOfStream;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.initPeerConnection(streamId, "publish");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.remotePeerConnection[streamId].createOffer(this.sdp_constraints)</span>
            .then(<span class="fstat-no" title="function not covered" >co</span>nfiguration =&gt; {
<span class="cstat-no" title="statement not covered" >                this.gotDescription(configuration, streamId);</span>
            })
            .catch(<span class="fstat-no" title="function not covered" >(e</span>rror) =&gt; {
<span class="cstat-no" title="statement not covered" >                Logger.error("create offer error for stream id: " + streamId + " error: " + error);</span>
            });
    };
&nbsp;
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    to</span>ggleVideo(streamId, trackId, enabled) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
            command: "toggleVideo",
            streamId: streamId,
            trackId: trackId,
...
&nbsp;
     ...
     *
     */
<span class="fstat-no" title="function not covered" >    to</span>ggleAudio(streamId, trackId, enabled) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
            command: "toggleAudio",
            streamId: streamId,
            trackId: trackId,
...
&nbsp;
     ...
     * @param {string} streamId : unique id for the stream
     */
<span class="fstat-no" title="function not covered" >    ge</span>tStats(streamId) {
<span class="cstat-no" title="statement not covered" >        Logger.debug("peerstatsgetstats = " + this.remotePeerConnectionStats[streamId]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.remotePeerConnection[streamId].getStats(null).then(<span class="fstat-no" title="function not covered" >st</span>ats =&gt; {</span>
            var bytesReceived = <span class="cstat-no" title="statement not covered" >-1;</span>
            var videoPacketsLost = <span class="cstat-no" title="statement not covered" >-1;</span>
            var audioPacketsLost = <span class="cstat-no" title="statement not covered" >-1;</span>
            var fractionLost = <span class="cstat-no" title="statement not covered" >-1;</span>
            var currentTime = <span class="cstat-no" title="statement not covered" >-1;</span>
            var bytesSent = <span class="cstat-no" title="statement not covered" >-1;</span>
            var videoPacketsSent = <span class="cstat-no" title="statement not covered" >-1;</span>
            var audioPacketsSent = <span class="cstat-no" title="statement not covered" >-1;</span>
            var audioLevel = <span class="cstat-no" title="statement not covered" >-1;</span>
            var qlr = <span class="cstat-no" title="statement not covered" >"";</span>
            var framesEncoded = <span class="cstat-no" title="statement not covered" >-1;</span>
            var width = <span class="cstat-no" title="statement not covered" >-1;</span>
            var height = <span class="cstat-no" title="statement not covered" >-1;</span>
            var fps = <span class="cstat-no" title="statement not covered" >-1;</span>
            var frameWidth = <span class="cstat-no" title="statement not covered" >-1;</span>
            var frameHeight = <span class="cstat-no" title="statement not covered" >-1;</span>
            var videoRoundTripTime = <span class="cstat-no" title="statement not covered" >-1;</span>
            var videoJitter = <span class="cstat-no" title="statement not covered" >-1;</span>
&nbsp;
            var audioRoundTripTime = <span class="cstat-no" title="statement not covered" >-1;</span>
            var audioJitter = <span class="cstat-no" title="statement not covered" >-1;</span>
&nbsp;
            var framesDecoded = <span class="cstat-no" title="statement not covered" >-1;</span>
            var framesDropped = <span class="cstat-no" title="statement not covered" >-1;</span>
            var framesReceived = <span class="cstat-no" title="statement not covered" >-1;</span>
&nbsp;
            var audioJitterAverageDelay = <span class="cstat-no" title="statement not covered" >-1;</span>
            var videoJitterAverageDelay = <span class="cstat-no" title="statement not covered" >-1;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >            stats.forEach(<span class="fstat-no" title="function not covered" >va</span>lue =&gt; {</span>
&nbsp;
                //Logger.debug(value);
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (value.type == "inbound-rtp" &amp;&amp; typeof value.kind != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                    bytesReceived += value.bytesReceived;</span>
<span class="cstat-no" title="statement not covered" >                    if (value.kind == "audio") {</span>
<span class="cstat-no" title="statement not covered" >                        audioPacketsLost = value.packetsLost;</span>
                    } else <span class="cstat-no" title="statement not covered" >if (value.kind == "video") {</span>
<span class="cstat-no" title="statement not covered" >                        videoPacketsLost = value.packetsLost;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    fractionLost += value.fractionLost;</span>
<span class="cstat-no" title="statement not covered" >                    currentTime = value.timestamp;</span>
&nbsp;
&nbsp;
                } else <span class="cstat-no" title="statement not covered" >if (value.type == "outbound-rtp") {//TODO: SPLIT AUDIO AND VIDEO BITRATES</span>
<span class="cstat-no" title="statement not covered" >                    if (value.kind == "audio") {</span>
<span class="cstat-no" title="statement not covered" >                        audioPacketsSent = value.packetsSent;</span>
                    } else <span class="cstat-no" title="statement not covered" >if (value.kind == "video") {</span>
<span class="cstat-no" title="statement not covered" >                        videoPacketsSent = value.packetsSent;</span>
                    }
<span class="cstat-no" title="statement not covered" >                    bytesSent += value.bytesSent</span>
<span class="cstat-no" title="statement not covered" >                    currentTime = value.timestamp</span>
<span class="cstat-no" title="statement not covered" >                    qlr = value.qualityLimitationReason;</span>
<span class="cstat-no" title="statement not covered" >                    if (value.framesEncoded != null) { //audio tracks are undefined here</span>
<span class="cstat-no" title="statement not covered" >                        framesEncoded += value.framesEncoded;</span>
                    }
                } else <span class="cstat-no" title="statement not covered" >if (value.type == "track" &amp;&amp; typeof value.kind != "undefined" &amp;&amp; value.kind == "audio") {</span>
<span class="cstat-no" title="statement not covered" >                    if (typeof value.audioLevel != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                        audioLevel = value.audioLevel;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (typeof value.jitterBufferDelay != "undefined" &amp;&amp; typeof value.jitterBufferEmittedCount != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                        audioJitterAverageDelay = value.jitterBufferDelay / value.jitterBufferEmittedCount;</span>
                    }
                } else <span class="cstat-no" title="statement not covered" >if (value.type == "track" &amp;&amp; typeof value.kind != "undefined" &amp;&amp; value.kind == "video") {</span>
<span class="cstat-no" title="statement not covered" >                    if (typeof value.frameWidth != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                        frameWidth = value.frameWidth;</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if (typeof value.frameHeight != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                        frameHeight = value.frameHeight;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (typeof value.framesDecoded != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                        framesDecoded = value.framesDecoded;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (typeof value.framesDropped != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                        framesDropped = value.framesDropped;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (typeof value.framesReceived != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                        framesReceived = value.framesReceived;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (typeof value.jitterBufferDelay != "undefined" &amp;&amp; typeof value.jitterBufferEmittedCount != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                        videoJitterAverageDelay = value.jitterBufferDelay / value.jitterBufferEmittedCount;</span>
                    }
                } else <span class="cstat-no" title="statement not covered" >if (value.type == "remote-inbound-rtp" &amp;&amp; typeof value.kind != "undefined") {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (typeof value.packetsLost != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                        if (value.kind == "video") {</span>
                            //this is the packetsLost for publishing
<span class="cstat-no" title="statement not covered" >                            videoPacketsLost = value.packetsLost;</span>
                        } else <span class="cstat-no" title="statement not covered" >if (value.kind == "audio") {</span>
                            //this is the packetsLost for publishing
<span class="cstat-no" title="statement not covered" >                            audioPacketsLost = value.packetsLost;</span>
                        }
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (typeof value.roundTripTime != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                        if (value.kind == "video") {</span>
<span class="cstat-no" title="statement not covered" >                            videoRoundTripTime = value.roundTripTime;</span>
                        } else <span class="cstat-no" title="statement not covered" >if (value.kind == "audio") {</span>
<span class="cstat-no" title="statement not covered" >                            audioRoundTripTime = value.roundTripTime;</span>
                        }
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (typeof value.jitter != "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                        if (value.kind == "video") {</span>
<span class="cstat-no" title="statement not covered" >                            videoJitter = value.jitter;</span>
                        } else <span class="cstat-no" title="statement not covered" >if (value.kind == "audio") {</span>
<span class="cstat-no" title="statement not covered" >                            audioJitter = value.jitter;</span>
                        }
                    }
                } else <span class="cstat-no" title="statement not covered" >if (value.type == "media-source") {</span>
<span class="cstat-no" title="statement not covered" >                    if (value.kind == "video") { //returns video source dimensions, not necessarily dimensions being encoded by browser</span>
<span class="cstat-no" title="statement not covered" >                        width = value.width;</span>
<span class="cstat-no" title="statement not covered" >                        height = value.height;</span>
<span class="cstat-no" title="statement not covered" >                        fps = value.framesPerSecond;</span>
                    }
                }
            });
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].totalBytesReceived = bytesReceived;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].videoPacketsLost = videoPacketsLost;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].audioPacketsLost = audioPacketsLost;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].fractionLost = fractionLost;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].currentTime = currentTime;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].totalBytesSent = bytesSent;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].totalVideoPacketsSent = videoPacketsSent;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].totalAudioPacketsSent = audioPacketsSent;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].audioLevel = audioLevel;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].qualityLimitationReason = qlr;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].totalFramesEncoded = framesEncoded;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].resWidth = width;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].resHeight = height;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].srcFps = fps;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].frameWidth = frameWidth;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].frameHeight = frameHeight;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].videoRoundTripTime = videoRoundTripTime;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].videoJitter = videoJitter;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].audioRoundTripTime = audioRoundTripTime;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].audioJitter = audioJitter;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].framesDecoded = framesDecoded;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].framesDropped = framesDropped;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].framesReceived = framesReceived;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].videoJitterAverageDelay = videoJitterAverageDelay;</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].audioJitterAverageDelay = audioJitterAverageDelay;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.notifyEventListeners("updated_stats", this.remotePeerConnectionStats[streamId]);</span>
&nbsp;
        });
    }
&nbsp;
     ...
     * @param {string} streamId: unique id for the stream
     */
<span class="fstat-no" title="function not covered" >    en</span>ableStats(streamId) {
<span class="cstat-no" title="statement not covered" >        if (this.remotePeerConnectionStats[streamId] == null) {</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId] = new PeerStats(streamId);</span>
<span class="cstat-no" title="statement not covered" >            this.remotePeerConnectionStats[streamId].timerId = setInterval(<span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                this.getStats(streamId);</span>
&nbsp;
            }, 5000);
        }
    }
&nbsp;
     ...
     * @param {string} streamId: unique id for the stream
     */
<span class="fstat-no" title="function not covered" >    di</span>sableStats(streamId) {
<span class="cstat-no" title="statement not covered" >        if (this.remotePeerConnectionStats[streamId] != null || typeof this.remotePeerConnectionStats[streamId] != 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >            clearInterval(this.remotePeerConnectionStats[streamId].timerId);</span>
        }
    }
&nbsp;
    ...
    checkWebSocketConnection() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.webSocketAdaptor == null || (<span class="branch-1 cbranch-no" title="branch not covered" >this.webSocketAdaptor.isConnected() == false </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >this.webSocketAdaptor.isConnecting() == false)</span>)
        {
            ...
            this.webSocketAdaptor = new WebSocketAdaptor({
                ...
                webrtcadaptor: this,
                callback: (info, obj) =&gt; {
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (info == "closed") {
...
&nbsp;
     ...
     * @param {*} data
     */
<span class="fstat-no" title="function not covered" >    pe</span>erMessage(streamId, definition, data) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    fo</span>rceStreamQuality(streamId, resolution) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
    ...
    sendData(streamId, data) {
        ...
        if (this.remotePeerConnection[streamId] !== undefined) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (dataChannel.readyState !== 'open') {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (typeof data === 'string' || data instanceof String) {</span>
<span class="cstat-no" title="statement not covered" >                dataChannel.send(data);</span>
            } else {
                var token = <span class="cstat-no" title="statement not covered" >Math.floor(Math.random() * 999999);</span>
                let header = <span class="cstat-no" title="statement not covered" >new Int32Array(2);</span>
<span class="cstat-no" title="statement not covered" >                header[0] = token;</span>
<span class="cstat-no" title="statement not covered" >                header[1] = length;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                dataChannel.send(header);</span>
&nbsp;
                var sent = <span class="cstat-no" title="statement not covered" >0;</span>
<span class="cstat-no" title="statement not covered" >                while (sent &lt; length) {</span>
                    var size = <span class="cstat-no" title="statement not covered" >Math.min(length - sent, CHUNK_SIZE);</span>
                    var buffer = <span class="cstat-no" title="statement not covered" >new Uint8Array(size + 4);</span>
                    var tokenArray = <span class="cstat-no" title="statement not covered" >new Int32Array(1);</span>
<span class="cstat-no" title="statement not covered" >                    tokenArray[0] = token;</span>
<span class="cstat-no" title="statement not covered" >                    buffer.set(new Uint8Array(tokenArray.buffer, 0, 4), 0);</span>
&nbsp;
                    var chunk = <span class="cstat-no" title="statement not covered" >data.slice(sent, sent + size);</span>
<span class="cstat-no" title="statement not covered" >                    buffer.set(new Uint8Array(chunk), 4);</span>
<span class="cstat-no" title="statement not covered" >                    sent += size;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    dataChannel.send(buffer);</span>
                }
            }
        } else <span class="missing-if-branch" title="else path not taken" >E</span>{
<span class="cstat-no" title="statement not covered" >            Logger.warn("Send data is called for undefined peer connection with stream id: " + streamId);</span>
        }
    }
&nbsp;
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    en</span>ableAudioLevel(stream, streamId) {
        const soundMeter = <span class="cstat-no" title="statement not covered" >new SoundMeter(this.mediaManager.audioContext);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        soundMeter.connectToSource(stream, <span class="fstat-no" title="function not covered" >()</span> =&gt; {}, <span class="fstat-no" title="function not covered" >fu</span>nction (e) {</span>
<span class="cstat-no" title="statement not covered" >            if (e) {</span>
<span class="cstat-no" title="statement not covered" >                alert(e);</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
<span class="cstat-no" title="statement not covered" >            Logger.debug("Added sound meter for stream: " + streamId + " = " + soundMeter.instant.toFixed(2));</span>
        });
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.soundMeters[streamId] = soundMeter;</span>
    }
&nbsp;
    /**
     * Called by the user
     ...
     * @param {*} streamsList
     */
<span class="fstat-no" title="function not covered" >    ge</span>tSoundLevelList(streamsList) {
<span class="cstat-no" title="statement not covered" >        for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; streamsList.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >            this.soundLevelList[streamsList[i]] = this.soundMeters[streamsList[i]].instant.toFixed(2);</span>
        }
<span class="cstat-no" title="statement not covered" >        this.notifyEventListeners("gotSoundList", this.soundLevelList);</span>
    }
&nbsp;
    /**
     ...
     * @returns
     */
<span class="fstat-no" title="function not covered" >    ge</span>tSender(streamId, type) {
        var sender = <span class="cstat-no" title="statement not covered" >null;</span>
<span class="cstat-no" title="statement not covered" >        if (this.remotePeerConnection[streamId] != null) {</span>
<span class="cstat-no" title="statement not covered" >            sender = this.remotePeerConnection[streamId].getSenders().find(<span class="fstat-no" title="function not covered" >fu</span>nction (s) {</span>
<span class="cstat-no" title="statement not covered" >                return s.track.kind == type;</span>
            });
        }
<span class="cstat-no" title="statement not covered" >        return sender;</span>
    }
&nbsp;
    /**
     * Called by user
     ...
     * @returns
     */
<span class="fstat-no" title="function not covered" >    as</span>signVideoTrack(videoTrackId, streamId, enabled) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
     ...
     * @returns
     */
<span class="fstat-no" title="function not covered" >    up</span>dateVideoTrackAssignments(streamId, offset, size) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
            streamId: streamId,
...
&nbsp;
     ...
     * @returns
     */
<span class="fstat-no" title="function not covered" >    se</span>tMaxVideoTrackCount(streamId, maxTrackCount) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
            streamId: streamId,
...
&nbsp;
     ...
     * @returns 
     */
<span class="fstat-no" title="function not covered" >    up</span>dateAudioLevel(streamId, value) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
            streamId: streamId,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.sendData(streamId, JSON.stringify(jsCmd));</span>
    }
&nbsp;
    /**
     * Called by user
     ...
     * @returns
     */
<span class="fstat-no" title="function not covered" >    ge</span>tDebugInfo(streamId) {
        var jsCmd = <span class="cstat-no" title="statement not covered" >{</span>
            streamId: streamId,
...
&nbsp;
     ...
     * @param {string} streamId
     */
<span class="fstat-no" title="function not covered" >    tu</span>rnOffLocalCamera(streamId) {
<span class="cstat-no" title="statement not covered" >        this.mediaManager.turnOffLocalCamera(streamId);</span>
    }
    /**
     * 
     * @param {string} streamId 
     * @returns 
     */
<span class="fstat-no" title="function not covered" >    tu</span>rnOnLocalCamera(streamId) {
<span class="cstat-no" title="statement not covered" >        return this.mediaManager.turnOnLocalCamera(streamId);</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    mu</span>teLocalMic() {
<span class="cstat-no" title="statement not covered" >        this.mediaManager.muteLocalMic();</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    un</span>muteLocalMic() {
<span class="cstat-no" title="statement not covered" >        this.mediaManager.unmuteLocalMic();</span>
    }
    /**
     * 
     * @param {string} streamId 
     * @returns 
     */
<span class="fstat-no" title="function not covered" >    sw</span>itchDesktopCapture(streamId) {
<span class="cstat-no" title="statement not covered" >        return this.mediaManager.switchDesktopCapture(streamId);</span>
    }
&nbsp;
    /**
     ...
     * @returns {Promise}
     */
<span class="fstat-no" title="function not covered" >    sw</span>itchVideoCameraCapture(streamId, deviceId) {
<span class="cstat-no" title="statement not covered" >        return this.mediaManager.switchVideoCameraCapture(streamId, deviceId);</span>
    }
&nbsp;
    /**
     ...
     * @returns {Promise}
     */
<span class="fstat-no" title="function not covered" >    up</span>dateVideoTrack(stream, streamId, onEndedCallback, stopDesktop) {
<span class="cstat-no" title="statement not covered" >        return this.mediaManager.updateVideoTrack(stream, streamId, onEndedCallback, stopDesktop);</span>
    }
&nbsp;
    /**
     * Called by User
     ...
     */
<span class="fstat-no" title="function not covered" >    sw</span>itchVideoCameraFacingMode(streamId, facingMode) {
<span class="cstat-no" title="statement not covered" >        return this.mediaManager.switchVideoCameraFacingMode(streamId, facingMode);</span>
    }
    /**
     * 
     * @param {string} streamId 
     * @returns 
     */
<span class="fstat-no" title="function not covered" >    sw</span>itchDesktopCaptureWithCamera(streamId) {
<span class="cstat-no" title="statement not covered" >        return this.mediaManager.switchDesktopCaptureWithCamera(streamId);</span>
    }
    /**
     * 
     * @param {string} streamId 
     ...
     * @returns 
     */
<span class="fstat-no" title="function not covered" >    sw</span>itchAudioInputSource(streamId, deviceId) {
<span class="cstat-no" title="statement not covered" >        return this.mediaManager.switchAudioInputSource(streamId, deviceId);</span>
    }
    /**
     * 
     * @param {number} volumeLevel 
     */
<span class="fstat-no" title="function not covered" >    se</span>tVolumeLevel(volumeLevel) {
<span class="cstat-no" title="statement not covered" >        this.mediaManager.setVolumeLevel(volumeLevel);</span>
    }
    /**
     * 
...
&nbsp;
     ...
     * @returns 
     */
<span class="fstat-no" title="function not covered" >    ap</span>plyConstraints(constraints) {
<span class="cstat-no" title="statement not covered" >        return this.mediaManager.applyConstraints(constraints)</span>
    };
    /**
     * 
     ...
     * @param {string} streamId 
     */
<span class="fstat-no" title="function not covered" >    ch</span>angeBandwidth(bandwidth, streamId) {
<span class="cstat-no" title="statement not covered" >        this.mediaManager.changeBandwidth(bandwidth, streamId);</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    en</span>ableAudioLevelWhenMuted() {
<span class="cstat-no" title="statement not covered" >        this.mediaManager.enableAudioLevelWhenMuted();</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    di</span>sableAudioLevelWhenMuted() {
<span class="cstat-no" title="statement not covered" >        this.mediaManager.disableAudioLevelWhenMuted();</span>
    }
    /**
     * 
     * @param {string} streamId 
     * @returns 
     */
<span class="fstat-no" title="function not covered" >    ge</span>tVideoSender(streamId) {
<span class="cstat-no" title="statement not covered" >        return this.mediaManager.getVideoSender(streamId);</span>
    }
    /**
     * 
     ...
     * @returns 
     */
<span class="fstat-no" title="function not covered" >    op</span>enStream(mediaConstraints) {
<span class="cstat-no" title="statement not covered" >        return this.mediaManager.openStream(mediaConstraints);</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    cl</span>oseStream() {
<span class="cstat-no" title="statement not covered" >        return this.mediaManager.closeStream();</span>
    };
}
&nbsp;
&nbsp;
