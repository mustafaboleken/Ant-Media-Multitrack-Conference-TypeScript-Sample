...
<head>
    <title>Code coverage report for embedded-player.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> embedded-player.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">69.04% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>261/378</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">59.89% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>112/187</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>35/60</span>
            </div>
...
<a name='L1026'></a><a href='#L1026'>1026</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (isMobile()) {
<span class="cstat-no" title="statement not covered" >            this.autoPlay = false;</span>
        }
        else {
...
<span class="cstat-no" title="statement not covered" >                Logger.warn("targetLatency parameter is not a number. It will be ignored.");</span>
            }
        }
&nbsp;
...
&nbsp;
     ...
     */
    loadScripts() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.playOrder.includes("hls") || <span class="branch-1 cbranch-no" title="branch not covered" >this.playOrder.includes("vod") </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >this.playOrder.includes("webrtc"))</span> {
...
&nbsp;
            ...
            videoJsExternalJs.onload = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
&nbsp;
                var videoJsQualityLevel = <span class="cstat-no" title="statement not covered" >this.dom.createElement("script");</span>
<span class="cstat-no" title="statement not covered" >                videoJsQualityLevel.type = "text/javascript";</span>
<span class="cstat-no" title="statement not covered" >                videoJsQualityLevel.src = "js/external/videojs-contrib-quality-levels.min.js";</span>
<span class="cstat-no" title="statement not covered" >                this.dom.head.appendChild(videoJsQualityLevel);</span>
&nbsp;
                var videoJsQualitySelector = <span class="cstat-no" title="statement not covered" >this.dom.createElement("script");</span>
<span class="cstat-no" title="statement not covered" >                videoJsQualitySelector.type = "text/javascript";</span>
<span class="cstat-no" title="statement not covered" >                videoJsQualitySelector.src = "js/external/videojs-hls-quality-selector.min.js";</span>
<span class="cstat-no" title="statement not covered" >                this.dom.head.appendChild(videoJsQualitySelector);</span>
&nbsp;
            }
        }
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.playOrder.includes("webrtc")) {
...
&nbsp;
     ...
     * enable 360 player
     */
<span class="fstat-no" title="function not covered" >    en</span>able360Player() {
<span class="cstat-no" title="statement not covered" >        this.aScene = this.dom.createElement("a-scene");</span>
        var elementId = <span class="cstat-no" title="statement not covered" >this.dom.getElementsByTagName("video")[0].id;</span>
<span class="cstat-no" title="statement not covered" >        this.aScene.innerHTML = "&lt;a-videosphere src=\"#"+elementId+"\" rotation=\"0 180 0\" style=\"background-color: antiquewhite\"&gt;&lt;/a-videosphere&gt;";</span>
<span class="cstat-no" title="statement not covered" >        this.dom.body.appendChild(this.aScene);</span>
    }
&nbsp;
    /**
...
&nbsp;
        if (this.is360) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (visible) {
<span class="cstat-no" title="statement not covered" >                this.enable360Player();</span>
            }
            else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.aScene != null) {
                var elements = <span class="cstat-no" title="statement not covered" >this.dom.getElementsByTagName("a-scene");</span>
<span class="cstat-no" title="statement not covered" >                while (elements.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    this.dom.body.removeChild(elements[0]);</span>
<span class="cstat-no" title="statement not covered" >                    elements = this.dom.getElementsByTagName("a-scene");</span>
                }
<span class="cstat-no" title="statement not covered" >                this.aScene = null;</span>
            }
        }
    }
&nbsp;
&nbsp;
    handleWebRTCInfoMessages(infos) {
	    if (infos["info"] == "ice_connection_state_changed") {
            ...
            else <span class="missing-if-branch" title="else path not taken" >E</span>if (infos["obj"].state == "failed" || <span class="branch-1 cbranch-no" title="branch not covered" >infos["obj"].state == "disconnected" </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >infos["obj"].state == "closed")</span> {
				//
...
&nbsp;
        ...
        else <span class="missing-if-branch" title="else path not taken" >E</span>if (infos["info"] == "closed") {
...
&nbsp;
    ...
    playWithVideoJS(streamUrl, extension) {
        ...
        else <span class="missing-if-branch" title="if path not taken" >I</span>if (extension == "webm") {
<span class="cstat-no" title="statement not covered" >            type = "video/webm";</span>
        }
        else <span class="missing-if-branch" title="if path not taken" >I</span>if (extension == "mov") {
<span class="cstat-no" title="statement not covered" >            type = "video/mp4";</span>
<span class="cstat-no" title="statement not covered" >            alert("Browsers do not support to play mov format");</span>
        }
        else <span class="missing-if-branch" title="if path not taken" >I</span>if (extension == "avi") {
<span class="cstat-no" title="statement not covered" >            type = "video/mp4";</span>
<span class="cstat-no" title="statement not covered" >            alert("Browsers do not support to play avi format");</span>
        }
        else if (extension == "m3u8") {
            type = "application/x-mpegURL";
        }
        else <span class="missing-if-branch" title="if path not taken" >I</span>if (extension == "mpd") {
<span class="cstat-no" title="statement not covered" >            type = "application/dash+xml";</span>
        }
        else if (extension == "webrtc") {
            type = "video/webrtc";
        }
        else <span class="missing-if-branch" title="else path not taken" >E</span>{
<span class="cstat-no" title="statement not covered" >            Logger.warn("Unknown extension: " + extension);</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
&nbsp;
        var preview = this.streamId;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.streamId.endsWith("_adaptive")) {
<span class="cstat-no" title="statement not covered" >            preview = streamId.substring(0, streamId.indexOf("_adaptive"));</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                    this.tryNextTech();</span>
<span class="cstat-no" title="statement not covered" >                    this.errorCalled = false;</span>
                }, 2500)
            }
        });
&nbsp;
...
&nbsp;
&nbsp;
	        this.videojsPlayer.on('webrtc-error', <span class="fstat-no" title="function not covered" >(e</span>vent, errors) =&gt; {
	            //some of the possible errors, NotFoundError, SecurityError,PermissionDeniedError
<span class="cstat-no" title="statement not covered" >	            Logger.warn("error callback: " + JSON.stringify(errors));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	            if (errors["error"] == "no_stream_exist" || errors["error"] == "WebSocketNotConnected"</span>
...
<span class="cstat-no" title="statement not covered" >	                this.tryNextTech();</span>
	            ...
	            else <span class="cstat-no" title="statement not covered" >if (errors["error"] == "notSetRemoteDescription") {</span>
	                /*
	                * If getting codec incompatible or remote description error, it will redirect HLS player.
	                */
<span class="cstat-no" title="statement not covered" >	                Logger.warn("notSetRemoteDescription error. Redirecting to HLS player.");</span>
<span class="cstat-no" title="statement not covered" >	                this.playIfExists("hls");</span>
	            }
	        });
&nbsp;
	        this.videojsPlayer.on("webrtc-data-received", <span class="fstat-no" title="function not covered" >(e</span>vent, obj) =&gt; {
<span class="cstat-no" title="statement not covered" >	            Logger.warn("webrtc-data-received: " + JSON.stringify(obj));</span>
<span class="cstat-no" title="statement not covered" >	            if (this.webRTCDataListener != null) {</span>
<span class="cstat-no" title="statement not covered" >	                this.webRTCDataListener(obj);</span>
	            }
	        });
        }
&nbsp;
		//hls specific calls
		if (extension == "m3u8") {
	        videojs.Vhs.xhr.beforeRequest = <span class="fstat-no" title="function not covered" >(o</span>ptions) =&gt; {
&nbsp;
                var securityParams = <span class="cstat-no" title="statement not covered" >this.getSecurityQueryParams();</span>
<span class="cstat-no" title="statement not covered" >                if (!options.uri.includes(securityParams))</span>
                {
<span class="cstat-no" title="statement not covered" >                    if (!options.uri.endsWith("?"))</span>
                    {
<span class="cstat-no" title="statement not covered" >                        options.uri = options.uri + "?";</span>
                    }
<span class="cstat-no" title="statement not covered" >                    options.uri += securityParams;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                Logger.debug("hls request: " + options.uri);</span>
<span class="cstat-no" title="statement not covered" >	            return options;</span>
	        };
&nbsp;
&nbsp;
	        this.videojsPlayer.ready(<span class="fstat-no" title="function not covered" >()</span> =&gt; {
&nbsp;
	            // If it's already added to player, no need to add again
<span class="cstat-no" title="statement not covered" >	            if (typeof this.videojsPlayer.hlsQualitySelector === "function") {</span>
<span class="cstat-no" title="statement not covered" >	                this.videojsPlayer.hlsQualitySelector({</span>
	                    displayCurrentQuality: true,
	                });
	            }
&nbsp;
	            // If there is no adaptive option in m3u8 no need to show quality selector
	            let qualityLevels = <span class="cstat-no" title="statement not covered" >this.videojsPlayer.qualityLevels();</span>
<span class="cstat-no" title="statement not covered" >	            qualityLevels.on('addqualitylevel', <span class="fstat-no" title="function not covered" >fu</span>nction (event) {</span>
	                let qualityLevel = <span class="cstat-no" title="statement not covered" >event.qualityLevel;</span>
<span class="cstat-no" title="statement not covered" >	                if (qualityLevel.height) {</span>
<span class="cstat-no" title="statement not covered" >	                    qualityLevel.enabled = true;</span>
	                } else {
<span class="cstat-no" title="statement not covered" >	                    qualityLevels.removeQualityLevel(qualityLevel);</span>
<span class="cstat-no" title="statement not covered" >	                    qualityLevel.enabled = false;</span>
	                }
	            });
	        });
        }
...
&nbsp;
        this.videojsPlayer.on('ended', <span class="fstat-no" title="function not covered" >()</span> =&gt; {
            //reinit to play after it ends
<span class="cstat-no" title="statement not covered" >            Logger.warn("stream is ended")</span>
<span class="cstat-no" title="statement not covered" >            this.setPlayerVisible(false);</span>
            ...
            //2. stream is ended
<span class="cstat-no" title="statement not covered" >            if (this.currentPlayType != "vod") {</span>
                //if it's vod, it means that stream is ended and no need to replay
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (this.iceConnected) {</span>
...
<span class="cstat-no" title="statement not covered" >                    this.playIfExists(this.playOrder[0]);</span>
                }
                else <span class="cstat-no" title="statement not covered" >if (this.currentPlayType == "hls") {</span>
                    //if it's hls, it means that stream is ended
&nbsp;
<span class="cstat-no" title="statement not covered" >                    this.setPlayerVisible(false);</span>
<span class="cstat-no" title="statement not covered" >                    if (this.playOrder[0] = "hls")</span>
                    {
...
<span class="cstat-no" title="statement not covered" >            if (this.playerListener != null) {</span>
<span class="cstat-no" title="statement not covered" >                this.playerListener("ended");</span>
            }
&nbsp;
        });
&nbsp;
        ...
        this.videojsPlayer.on("play", <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >            this.setPlayerVisible(true);</span>
<span class="cstat-no" title="statement not covered" >            if (this.playerListener != null) {</span>
<span class="cstat-no" title="statement not covered" >                this.playerListener("play");</span>
            }
        });
        this.iceConnected = false;
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.autoPlay) {
...
&nbsp;
        ...
        streamPath += streamId;
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (extension != null &amp;&amp; extension != "") {
...
&nbsp;
                    return fetch(streamPath, { method: 'HEAD' })
                        .then((response) =&gt; {
                            <span class="missing-if-branch" title="if path not taken" >I</span>if (response.status == 200) {
<span class="cstat-no" title="statement not covered" >                                return new Promise(<span class="fstat-no" title="function not covered" >fu</span>nction (resolve, reject) {</span>
<span class="cstat-no" title="statement not covered" >                                    resolve(streamPath);</span>
                                });
                            }
                            else {
...
<span class="cstat-no" title="statement not covered" >			Logger.debug("tryNextTech is already scheduled no need to schedule again");</span>
		}
    }
&nbsp;
    /**
...
&nbsp;
                    var securityParams = this.getSecurityQueryParams();
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (!url.includes(securityParams))
                    {
<span class="cstat-no" title="statement not covered" >                        if (!url.endsWith("?"))</span>
                        {
<span class="cstat-no" title="statement not covered" >                            url += "?";</span>
                        }
<span class="cstat-no" title="statement not covered" >                        modifiedUrl = url + securityParams;</span>
<span class="cstat-no" title="statement not covered" >						Logger.warn(modifiedUrl);</span>
<span class="cstat-no" title="statement not covered" >						return modifiedUrl</span>
                    }
&nbsp;
                    return url;
                },
...
&nbsp;
        this.dashLatencyTimer = setInterval(<span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >            Logger.warn("live latency: " + this.dashPlayer.getCurrentLiveLatency());</span>
        }, 2000);
&nbsp;
&nbsp;
       	this.makeDashPlayerVisibleWhenInitialized();
&nbsp;
        this.dashPlayer.on(dashjs.MediaPlayer.events.PLAYBACK_PLAYING, <span class="fstat-no" title="function not covered" >(e</span>vent) =&gt; {
<span class="cstat-no" title="statement not covered" >            Logger.warn("playback started");</span>
<span class="cstat-no" title="statement not covered" >            this.setPlayerVisible(true);</span>
<span class="cstat-no" title="statement not covered" >            if (this.playerListener != null) {</span>
<span class="cstat-no" title="statement not covered" >                this.playerListener("play");</span>
            }
        });
        this.dashPlayer.on(dashjs.MediaPlayer.events.PLAYBACK_ENDED, <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >            Logger.warn("playback ended");</span>
<span class="cstat-no" title="statement not covered" >            this.destroyDashPlayer();</span>
<span class="cstat-no" title="statement not covered" >            this.setPlayerVisible(false);</span>
            //streaming can be started again so try to play again with preferred tech
<span class="cstat-no" title="statement not covered" >            if (this.playOrder[0] = "dash")</span>
            {
...
<span class="cstat-no" title="statement not covered" >                this.playerListener("ended");</span>
        ...
        this.dashPlayer.on(dashjs.MediaPlayer.events.PLAYBACK_ERROR, <span class="fstat-no" title="function not covered" >(e</span>vent) =&gt; {
<span class="cstat-no" title="statement not covered" >            this.tryNextTech();</span>
        });
        this.dashPlayer.on(dashjs.MediaPlayer.events.ERROR, <span class="fstat-no" title="function not covered" >(e</span>vent) =&gt; {
<span class="cstat-no" title="statement not covered" >            this.tryNextTech();</span>
        });
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    ma</span>keDashPlayerVisibleWhenInitialized() {
<span class="cstat-no" title="statement not covered" >		 this.dashPlayer.on(dashjs.MediaPlayer.events.STREAM_INITIALIZED, <span class="fstat-no" title="function not covered" >(e</span>vent) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            Logger.warn("Stream initialized");</span>
...
&nbsp;
     ...
     */
    destroyDashPlayer() {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.dashPlayer) {
<span class="cstat-no" title="statement not covered" >            this.dashPlayer.destroy();</span>
<span class="cstat-no" title="statement not covered" >            this.dashPlayer = null;</span>
<span class="cstat-no" title="statement not covered" >            clearInterval(this.dashLatencyTimer);</span>
        }
    }
&nbsp;
    /**
    ...
    destroyVideoJSPlayer() {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.videojsPlayer) {
<span class="cstat-no" title="statement not covered" >            this.videojsPlayer.dispose();</span>
<span class="cstat-no" title="statement not covered" >            this.videojsPlayer = null;</span>
        }
    }
&nbsp;
    /**
...
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (location.protocol.startsWith("https")) {
<span class="cstat-no" title="statement not covered" >                    websocketURL = "wss://" + path;</span>
                }
&nbsp;
...
&nbsp;
                    ...
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.playType.length &gt; 1) {
                        Logger.warn("Try next play type which is " + this.playType[1] + ".")
                        this.checkStreamExistsViaHttp(EmbeddedPlayer.STREAMS_FOLDER, this.streamId, this.playType[1]).then(<span class="fstat-no" title="function not covered" >(s</span>treamPath) =&gt; {
<span class="cstat-no" title="statement not covered" >                            this.playWithVideoJS(streamPath, this.playType[1]);</span>
                        }).catch((error) =&gt; {
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    mu</span>tePlayer(mutestatus)
    {
<span class="cstat-no" title="statement not covered" >        this.mute = mutestatus;</span>
<span class="cstat-no" title="statement not covered" >        if (this.videojsPlayer) {</span>
<span class="cstat-no" title="statement not covered" >            this.videojsPlayer.muted(mutestatus);</span>
        }
<span class="cstat-no" title="statement not covered" >        if (this.dashPlayer) {</span>
<span class="cstat-no" title="statement not covered" >            this.dashPlayer.setMute(mutestatus);</span>
        }
    }
&nbsp;
    /**
...
&nbsp;
<span class="fstat-no" title="function not covered" >    ad</span>dPlayerListener(playerListener) {
<span class="cstat-no" title="statement not covered" >        this.playerListener = playerListener;</span>
    }
&nbsp;
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    ad</span>dWebRTCDataListener(webRTCDataListener) {
<span class="cstat-no" title="statement not covered" >        this.webRTCDataListener = webRTCDataListener</span>
    }
&nbsp;
    /**
     *
     * @param {*} data
     */
<span class="fstat-no" title="function not covered" >    se</span>ndWebRTCData(data) {
<span class="cstat-no" title="statement not covered" >        if (this.videojsPlayer &amp;&amp; this.currentPlayType == "webrtc") {</span>
<span class="cstat-no" title="statement not covered" >            this.videojsPlayer.sendDataViaWebRTC(data);</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >            Logger.warn("Player is not ready or playType is not WebRTC");</span>
        }
    }
&nbsp;
&nbsp;
